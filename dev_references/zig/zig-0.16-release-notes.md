...
[<span id="logo"></span>](https://ziglang.org/)

# 0.16.0 Release Notes

<img src="../../img/Carmen_7.svg" style="height: 18em; float: right"
alt="Carmen the Allocgator" />
...
Zig development is funded via [Zig Software
Foundation](https://ziglang.org/zsf/), a 501(c)(3) non-profit
organization. Please consider a recurring donation so that we can offer
more billable hours to our core team members. This is the most
straightforward way to accelerate the project along the
[Roadmap](release-notes.html#Roadmap) to 1.0. If you need **donation
receipts** or are looking to migrate away from GitHub Sponsors, we
recommend [donating via
...
Interface](release-notes.html#IO-as-an-Interface), but don't sleep on
the [Language Changes](release-notes.html#Language-Changes) or
enhancements to the [Compiler](release-notes.html#Compiler), [Build
System](release-notes.html#Build-System),
[Linker](release-notes.html#Linker),
[Fuzzer](release-notes.html#Fuzzer), and
[Toolchain](release-notes.html#Toolchain) which are also included in
this release.

## [Table of Contents](release-notes.html#toc-Table-of-Contents) <a href="release-notes.html#Table-of-Contents" class="hdr">§</a>

- <a href="release-notes.html#Table-of-Contents"
  id="toc-Table-of-Contents">Table of Contents</a>
- <a href="release-notes.html#Target-Support"
  id="toc-Target-Support">Target Support</a>
  - <a href="release-notes.html#Tier-System" id="toc-Tier-System">Tier
    System</a>
    - <a href="release-notes.html#Tier-1" id="toc-Tier-1">Tier 1</a>
    - <a href="release-notes.html#Tier-2" id="toc-Tier-2">Tier 2</a>
    - <a href="release-notes.html#Tier-3" id="toc-Tier-3">Tier 3</a>
    - <a href="release-notes.html#Tier-4" id="toc-Tier-4">Tier 4</a>
  - <a href="release-notes.html#Support-Table"
    id="toc-Support-Table">Support Table</a>
  - <a href="release-notes.html#OS-Version-Requirements"
    id="toc-OS-Version-Requirements">OS Version Requirements</a>
  - <a href="release-notes.html#Additional-Platforms"
    id="toc-Additional-Platforms">Additional Platforms</a>
- <a href="release-notes.html#Language-Changes"
  id="toc-Language-Changes">Language Changes</a>
  - <a href="release-notes.html#switch" id="toc-switch">switch</a>
  - <a href="release-notes.html#Equality-Comparisons-on-Packed-Unions"
    id="toc-Equality-Comparisons-on-Packed-Unions">Equality Comparisons on
    Packed Unions</a>
  - <a href="release-notes.html#cImport-Moving-to-Build-System"
    id="toc-cImport-Moving-to-Build-System">@cImport Moving to Build
    System</a>
  - <a
    href="release-notes.html#Type-Replaced-with-Individual-Type-Creating-Builtin-Functions"
    id="toc-Type-Replaced-with-Individual-Type-Creating-Builtin-Functions">@Type
    Replaced with Individual Type-Creating Builtin Functions</a>
  - <a
    href="release-notes.html#Allow-Small-Integer-Types-to-Coerce-to-Floats"
    id="toc-Allow-Small-Integer-Types-to-Coerce-to-Floats">Allow Small
    Integer Types to Coerce to Floats</a>
  - <a href="release-notes.html#Forbid-Runtime-Vector-Indexes"
    id="toc-Forbid-Runtime-Vector-Indexes">Forbid Runtime Vector Indexes</a>
  - <a
    href="release-notes.html#Vectors-and-Arrays-No-Longer-Support-In-Memory-Coercion"
    id="toc-Vectors-and-Arrays-No-Longer-Support-In-Memory-Coercion">Vectors
    and Arrays No Longer Support In-Memory Coercion</a>
  - <a
    href="release-notes.html#Forbid-Trivial-Local-Address-Returned-from-Functions"
    id="toc-Forbid-Trivial-Local-Address-Returned-from-Functions">Forbid
    Trivial Local Address Returned from Functions</a>
  - <a href="release-notes.html#Unary-Float-Builtins-Forward-Result-Type"
    id="toc-Unary-Float-Builtins-Forward-Result-Type">Unary Float Builtins
    Forward Result Type</a>
  - <a
    href="release-notes.html#floor-ceil-round-trunc-Conversion-to-Integers"
    id="toc-floor-ceil-round-trunc-Conversion-to-Integers">@floor, @ceil,
    @round, @trunc Conversion to Integers</a>
  - <a href="release-notes.html#Forbid-Unused-Bits-in-Packed-Unions"
    id="toc-Forbid-Unused-Bits-in-Packed-Unions">Forbid Unused Bits in
    Packed Unions</a>
  - <a
    href="release-notes.html#Forbid-Pointers-in-Packed-Structs-and-Unions"
    id="toc-Forbid-Pointers-in-Packed-Structs-and-Unions">Forbid Pointers in
    Packed Structs and Unions</a>
  - <a
    href="release-notes.html#Allow-Explicit-Backing-Integers-on-Packed-Unions"
    id="toc-Allow-Explicit-Backing-Integers-on-Packed-Unions">Allow Explicit
    Backing Integers on Packed Unions</a>
  - <a
    href="release-notes.html#Forbid-Enum-and-Packed-Types-with-Implicit-Backing-Types-in-Extern-Contexts"
    id="toc-Forbid-Enum-and-Packed-Types-with-Implicit-Backing-Types-in-Extern-Contexts">Forbid
    Enum and Packed Types with Implicit Backing Types in Extern Contexts</a>
  - <a href="release-notes.html#Lazy-Field-Analysis"
    id="toc-Lazy-Field-Analysis">Lazy Field Analysis</a>
  - <a
    href="release-notes.html#Pointers-to-Comptime-Only-Types-Are-No-Longer-Comptime-Only"
    id="toc-Pointers-to-Comptime-Only-Types-Are-No-Longer-Comptime-Only">Pointers
    to Comptime-Only Types Are No Longer Comptime-Only</a>
  - <a
    href="release-notes.html#Explicitly-Aligned-Pointer-Types-Now-Distinct-from-Naturally-Aligned-Pointer-Types"
    id="toc-Explicitly-Aligned-Pointer-Types-Now-Distinct-from-Naturally-Aligned-Pointer-Types">Explicitly-Aligned
    Pointer Types Now Distinct from Naturally-Aligned Pointer Types</a>
  - <a href="release-notes.html#Simplified-Dependency-Loop-Rules"
    id="toc-Simplified-Dependency-Loop-Rules">Simplified Dependency Loop
    Rules</a>
  - <a
    href="release-notes.html#Zero-bit-Tuple-Fields-No-Longer-Implicitly-comptime"
    id="toc-Zero-bit-Tuple-Fields-No-Longer-Implicitly-comptime">Zero-bit
    Tuple Fields No Longer Implicitly comptime</a>
- <a href="release-notes.html#Standard-Library"
  id="toc-Standard-Library">Standard Library</a>
  - <a href="release-notes.html#IO-as-an-Interface"
    id="toc-IO-as-an-Interface">I/O as an Interface</a>
    - <a href="release-notes.html#Future" id="toc-Future">Future</a>
    - <a href="release-notes.html#Group" id="toc-Group">Group</a>
    - <a href="release-notes.html#Cancelation"
      id="toc-Cancelation">Cancelation</a>
    - <a href="release-notes.html#Batch" id="toc-Batch">Batch</a>
    - <a href="release-notes.html#Sync-Primitives"
      id="toc-Sync-Primitives">Sync Primitives</a>
    - <a href="release-notes.html#Entropy" id="toc-Entropy">Entropy</a>
    - <a href="release-notes.html#Time" id="toc-Time">Time</a>
    - <a href="release-notes.html#File-System" id="toc-File-System">File
      System</a>
    - <a href="release-notes.html#Networking"
      id="toc-Networking">Networking</a>
    - <a href="release-notes.html#Process" id="toc-Process">Process</a>
    - <a href="release-notes.html#FileMemoryMap"
      id="toc-FileMemoryMap">File.MemoryMap</a>
    - <a href="release-notes.html#posix-and-oswindows-removals"
      id="toc-posix-and-oswindows-removals">posix and os.windows removals</a>
  - <a
    href="release-notes.html#heapArenaAllocator-Becomes-Thread-Safe-and-Lock-Free"
    id="toc-heapArenaAllocator-Becomes-Thread-Safe-and-Lock-Free">heap.ArenaAllocator
    Becomes Thread-Safe and Lock-Free</a>
  - <a href="release-notes.html#heapThreadSafe-Allocator-Removed"
    id="toc-heapThreadSafe-Allocator-Removed">heap.ThreadSafe Allocator
    Removed</a>
  - <a
    href="release-notes.html#Add-Deflate-Compression-Simplify-Decompression"
    id="toc-Add-Deflate-Compression-Simplify-Decompression">Add Deflate
    Compression, Simplify Decompression</a>
    - <a href="release-notes.html#Zlib-Comparison"
      id="toc-Zlib-Comparison">Zlib Comparison</a>
  - <a
    href="release-notes.html#Expanded-target-support-for-segfault-handlingunwinding"
    id="toc-Expanded-target-support-for-segfault-handlingunwinding">Expanded
    target support for segfault handling/unwinding</a>
  - <a
    href="release-notes.html#Removal-of-ucontext_t-and-related-typesfunctions"
    id="toc-Removal-of-ucontext_t-and-related-typesfunctions">Removal of
    ucontext_t and related types/functions</a>
  - <a href="release-notes.html#Debug-Information-Reworked"
    id="toc-Debug-Information-Reworked">Debug Information Reworked</a>
  - <a
    href="release-notes.html#Inter-Process-Progress-Reporting-for-Windows"
    id="toc-Inter-Process-Progress-Reporting-for-Windows">Inter-Process
    Progress Reporting for Windows</a>
  - <a href="release-notes.html#Windows-Networking-Without-ws2_32dll"
    id="toc-Windows-Networking-Without-ws2_32dll">Windows Networking Without
    ws2_32.dll</a>
  - <a href="release-notes.html#Completed-Migration-to-NtDll"
    id="toc-Completed-Migration-to-NtDll">Completed Migration to NtDll</a>
  - <a href="release-notes.html#Juicy-Main" id="toc-Juicy-Main">"Juicy
    Main"</a>
  - <a
    href="release-notes.html#Environment-Variables-and-Process-Arguments-Become-Non-Global"
    id="toc-Environment-Variables-and-Process-Arguments-Become-Non-Global">Environment
    Variables and Process Arguments Become Non-Global</a>
  - <a
    href="release-notes.html#mem-introduce-cut-functions-rename-index-of-to-find"
    id="toc-mem-introduce-cut-functions-rename-index-of-to-find">mem:
    introduce cut functions; rename "index of" to "find"</a>
  - <a href="release-notes.html#Selectively-Walking-Directory-Trees"
    id="toc-Selectively-Walking-Directory-Trees">Selectively Walking
    Directory Trees</a>
  - <a href="release-notes.html#fspath-Windows-Paths"
    id="toc-fspath-Windows-Paths">fs.path Windows Paths</a>
  - <a href="release-notes.html#fspathrelative-Became-Pure"
    id="toc-fspathrelative-Became-Pure">fs.path.relative Became Pure</a>
  - <a href="release-notes.html#FileStat-Make-Access-Time-Optional"
    id="toc-FileStat-Make-Access-Time-Optional">File.Stat: Make Access Time
    Optional</a>
  - <a href="release-notes.html#Preopens" id="toc-Preopens">"Preopens"</a>
  - <a href="release-notes.html#AtomicTemporary-Files"
    id="toc-AtomicTemporary-Files">Atomic/Temporary Files</a>
  - <a
    href="release-notes.html#Memory-Locking-and-Protection-API-Moved-to-process"
    id="toc-Memory-Locking-and-Protection-API-Moved-to-process">Memory
    Locking and Protection API Moved to process</a>
  - <a href="release-notes.html#Current-Directory-API-Renamed"
    id="toc-Current-Directory-API-Renamed">Current Directory API Renamed</a>
  - <a href="release-notes.html#Migration-to-Unmanaged-Containers"
    id="toc-Migration-to-Unmanaged-Containers">Migration to "Unmanaged"
    Containers</a>
  - <a href="release-notes.html#PriorityDequeue"
    id="toc-PriorityDequeue">PriorityDequeue</a>
  - <a href="release-notes.html#PriorityQueue"
    id="toc-PriorityQueue">PriorityQueue</a>
  - <a href="release-notes.html#ThreadPool-Removed"
    id="toc-ThreadPool-Removed">Thread.Pool Removed</a>
  - <a href="release-notes.html#Remove-builtinsubsystem"
    id="toc-Remove-builtinsubsystem">Remove builtin.subsystem</a>
  - <a
    href="release-notes.html#Move-TargetSubSystem-to-zigSubsystem-and-update-field-names"
    id="toc-Move-TargetSubSystem-to-zigSubsystem-and-update-field-names">Move
    Target.SubSystem to zig.Subsystem and update field names</a>
  - <a
    href="release-notes.html#Io-delete-GenericReader-AnyReader-FixedBufferStream"
    id="toc-Io-delete-GenericReader-AnyReader-FixedBufferStream">Io: delete
    GenericReader, AnyReader, FixedBufferStream</a>
  - <a
    href="release-notes.html#Replace-D-format-specifier-with-IoDuration-format-method"
    id="toc-Replace-D-format-specifier-with-IoDuration-format-method">Replace
    {D} format specifier with Io.Duration format method</a>
  - <a href="release-notes.html#fsgetAppDataDir-Removed"
    id="toc-fsgetAppDataDir-Removed">fs.getAppDataDir Removed</a>
  - <a href="release-notes.html#IoWriterAllocating-Alignment-Field"
    id="toc-IoWriterAllocating-Alignment-Field">Io.Writer.Allocating
    Alignment Field</a>
  - <a href="release-notes.html#fsDirreadFileAlloc"
    id="toc-fsDirreadFileAlloc">fs.Dir.readFileAlloc</a>
  - <a href="release-notes.html#fsFilereadToEndAlloc"
    id="toc-fsFilereadToEndAlloc">fs.File.readToEndAlloc</a>
  - <a href="release-notes.html#stdcrypto-add-AES-SIV-and-AES-GCM-SIV"
    id="toc-stdcrypto-add-AES-SIV-and-AES-GCM-SIV">std.crypto: add AES-SIV
    and AES-GCM-SIV</a>
  - <a
    href="release-notes.html#stdcrypto-add-Ascon-AEAD-Ascon-Hash-Ascon-CHash"
    id="toc-stdcrypto-add-Ascon-AEAD-Ascon-Hash-Ascon-CHash">std.crypto: add
    Ascon-AEAD, Ascon-Hash, Ascon-CHash</a>
- <a href="release-notes.html#Build-System" id="toc-Build-System">Build
  System</a>
  - <a href="release-notes.html#Ability-to-Override-Packages-Locally"
    id="toc-Ability-to-Override-Packages-Locally">Ability to Override
    Packages Locally</a>
  - <a href="release-notes.html#Fetch-Packages-Into-Project-Local-Directory"
    id="toc-Fetch-Packages-Into-Project-Local-Directory">Fetch Packages Into
    Project-Local Directory</a>
  - <a href="release-notes.html#Unit-Test-Timeouts"
    id="toc-Unit-Test-Timeouts">Unit Test Timeouts</a>
  - <a href="release-notes.html#Added-code--error-stylecode-Flag"
    id="toc-Added-code--error-stylecode-Flag">Added
    <code>--error-style</code> Flag</a>
  - <a href="release-notes.html#Added-code--multiline-errorscode-Flag"
    id="toc-Added-code--multiline-errorscode-Flag">Added
    <code>--multiline-errors</code> Flag</a>
  - <a href="release-notes.html#Temporary-Files-API"
    id="toc-Temporary-Files-API">Temporary Files API</a>
- <a href="release-notes.html#Compiler" id="toc-Compiler">Compiler</a>
  - <a href="release-notes.html#C-Translation" id="toc-C-Translation">C
    Translation</a>
  - <a href="release-notes.html#LLVM-Backend" id="toc-LLVM-Backend">LLVM
    Backend</a>
  - <a href="release-notes.html#Reworked-Byval-Syntax-Lowering"
    id="toc-Reworked-Byval-Syntax-Lowering">Reworked Byval Syntax
    Lowering</a>
  - <a href="release-notes.html#Reworked-Type-Resolution"
    id="toc-Reworked-Type-Resolution">Reworked Type Resolution</a>
  - <a href="release-notes.html#Incremental-Compilation"
    id="toc-Incremental-Compilation">Incremental Compilation</a>
  - <a href="release-notes.html#x86-Backend" id="toc-x86-Backend">x86
    Backend</a>
  - <a href="release-notes.html#aarch64-Backend"
    id="toc-aarch64-Backend">aarch64 Backend</a>
  - <a href="release-notes.html#WebAssembly-Backend"
    id="toc-WebAssembly-Backend">WebAssembly Backend</a>
  - <a
    href="release-notes.html#Generating-Import-Libraries-from-def-Files-Without-LLVM"
    id="toc-Generating-Import-Libraries-from-def-Files-Without-LLVM">Generating
    Import Libraries from .def Files Without LLVM</a>
  - <a
    href="release-notes.html#Improved-Code-Generation-of-For-Loop-Safety-Checks"
    id="toc-Improved-Code-Generation-of-For-Loop-Safety-Checks">Improved
    Code Generation of For Loop Safety Checks</a>
- <a href="release-notes.html#Linker" id="toc-Linker">Linker</a>
  - <a href="release-notes.html#New-ELF-Linker" id="toc-New-ELF-Linker">New
    ELF Linker</a>
- <a href="release-notes.html#Fuzzer" id="toc-Fuzzer">Fuzzer</a>
  - <a href="release-notes.html#Smith" id="toc-Smith">Smith</a>
  - <a href="release-notes.html#Multiprocess-Fuzzing"
    id="toc-Multiprocess-Fuzzing">Multiprocess Fuzzing</a>
  - <a href="release-notes.html#Fuzzing-Infinite-Mode"
    id="toc-Fuzzing-Infinite-Mode">Fuzzing Infinite Mode</a>
  - <a href="release-notes.html#Crash-Dumps" id="toc-Crash-Dumps">Crash
    Dumps</a>
  - <a
    href="release-notes.html#Numerous-bugs-found-and-fixed-with-the-help-of-an-AST-smith"
    id="toc-Numerous-bugs-found-and-fixed-with-the-help-of-an-AST-smith">Numerous
    bugs found and fixed with the help of an AST smith</a>
- <a href="release-notes.html#Bug-Fixes" id="toc-Bug-Fixes">Bug Fixes</a>
  - <a href="release-notes.html#This-Release-Contains-Bugs"
    id="toc-This-Release-Contains-Bugs">This Release Contains Bugs</a>
- <a href="release-notes.html#Toolchain" id="toc-Toolchain">Toolchain</a>
  - <a href="release-notes.html#LLVM-21" id="toc-LLVM-21">LLVM 21</a>
    - <a
      href="release-notes.html#Loop-Vectorization-Disabled-to-Work-Around-Regression"
      id="toc-Loop-Vectorization-Disabled-to-Work-Around-Regression">Loop
      Vectorization Disabled to Work Around Regression</a>
  - <a href="release-notes.html#musl-125" id="toc-musl-125">musl 1.2.5</a>
  - <a href="release-notes.html#glibc-243" id="toc-glibc-243">glibc 2.43</a>
  - <a href="release-notes.html#Linux-619-Headers"
    id="toc-Linux-619-Headers">Linux 6.19 Headers</a>
  - <a href="release-notes.html#macOS-264-Headers"
    id="toc-macOS-264-Headers">macOS 26.4 Headers</a>
  - <a href="release-notes.html#MinGW-w64" id="toc-MinGW-w64">MinGW-w64</a>
  - <a href="release-notes.html#FreeBSD-150-libc"
    id="toc-FreeBSD-150-libc">FreeBSD 15.0 libc</a>
  - <a href="release-notes.html#WASI-libc" id="toc-WASI-libc">WASI libc</a>
  - <a href="release-notes.html#zig-libc" id="toc-zig-libc">zig libc</a>
  - <a href="release-notes.html#zig-cc" id="toc-zig-cc">zig cc</a>
  - <a
    href="release-notes.html#Support-dynamically-linked-OpenBSD-libc-when-cross-compiling"
    id="toc-Support-dynamically-linked-OpenBSD-libc-when-cross-compiling">Support
    dynamically-linked OpenBSD libc when cross-compiling</a>
- <a href="release-notes.html#Roadmap" id="toc-Roadmap">Roadmap</a>
- <a href="release-notes.html#Thank-You-Contributors"
  id="toc-Thank-You-Contributors">Thank You Contributors!</a>
- <a href="release-notes.html#Thank-You-Sponsors"
  id="toc-Thank-You-Sponsors">Thank You Sponsors!</a>

## [Target Support](release-notes.html#toc-Target-Support) <a href="release-notes.html#Target-Support" class="hdr">§</a>

<img src="../../img/Zero_13.svg" style="height: 11em; float: right"
alt="Zero the Ziguana" />

Zig supports a wide range of architectures and operating systems. The
[Support Table](release-notes.html#Support-Table) and [Additional
Platforms](release-notes.html#Additional-Platforms) sections cover the
...
- Cross-compilation support for `aarch64-maccatalyst` and
  `x86_64-maccatalyst` has been added. This was 'free' in a sense, since
  the vendored `libSystem.tbd` that Zig ships already provides the
...
- Support for Oracle's Solaris and IBM's AIX and z/OS has been removed.
  In general, the Zig project cannot support proprietary operating
  systems that make it unreasonably difficult to obtain system headers
  and thus audit contributions. Note that this does not affect illumos;
  being an open source fork from OpenSolaris, it remains supported.
- [Stack tracing support has been significantly improved across the
  board](release-notes.html#Expanded-target-support-for-segfault-handlingunwinding);
  almost all major targets now provide stack traces on crashes.
- Various [Standard Library](release-notes.html#Standard-Library) bugs
  that mainly affected weakly-ordered architectures and targets with
  unusual page sizes have been fixed. Among others, this is known to
  have significantly improved reliability on AArch64 (especially w/o
  LSE), LoongArch, and Power ISA.
- Various [Standard Library](release-notes.html#Standard-Library) and
  [Compiler](release-notes.html#Compiler) bugs preventing Zig from
  working on big-endian hosts have been fixed.
- Big-endian ARM targets have been fixed to emit BE8 object files when
  targeting ARMv6+, rather than the legacy BE32 format.

### [Tier System](release-notes.html#toc-Tier-System) <a href="release-notes.html#Tier-System" class="hdr">§</a>
...
#### [Tier 1](release-notes.html#toc-Tier-1) <a href="release-notes.html#Tier-1" class="hdr">§</a>

- All non-experimental [language](release-notes.html#Language-Changes)
  features are known to work correctly.
- The [Compiler](release-notes.html#Compiler) can generate machine code
  for these targets without relying on
  [LLVM](release-notes.html#LLVM-21).

#### [Tier 2](release-notes.html#toc-Tier-2) <a href="release-notes.html#Tier-2" class="hdr">§</a>

- The [Standard Library](release-notes.html#Standard-Library)
  cross-platform abstractions account for these targets.
...
#### [Tier 3](release-notes.html#toc-Tier-3) <a href="release-notes.html#Tier-3" class="hdr">§</a>

- The [Compiler](release-notes.html#Compiler) can generate machine code
  for these targets via [LLVM](release-notes.html#LLVM-21).
- The [Linker](release-notes.html#Linker) can produce object files,
  libraries, and executables for these targets.
- These targets are not considered experimental by
  [LLVM](release-notes.html#LLVM-21).

#### [Tier 4](release-notes.html#toc-Tier-4) <a href="release-notes.html#Tier-4" class="hdr">§</a>

- The [Compiler](release-notes.html#Compiler) can generate assembly
  source code for these targets via [LLVM](release-notes.html#LLVM-21).

### [Support Table](release-notes.html#toc-Support-Table) <a href="release-notes.html#Support-Table" class="hdr">§</a>
...
<td><a href="https://github.com/ziglang/zig/issues/23079">1</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted">⚡</span></td>
<td>✅</td>
<td>✅</td>
<td>✅</td>
<td>✅</td>
...
<tr>
<td><code>aarch64-freebsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/3939">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
<td>✅</td>
<td>✅</td>
<td>✅</td>
<td>✅</td>
...
<tr>
<td><code>aarch64(_be)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/2443">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-maccatalyst</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25932">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<td><a href="https://github.com/ziglang/zig/issues/23078">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64(_be)-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23084">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23085">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-windows</code></td>
<td><a href="https://github.com/ziglang/zig/issues/16665">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<td><a href="https://github.com/ziglang/zig/issues/23675">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
<td>✅</td>
<td>✅</td>
<td>⚠️</td>
...
<tr>
<td><code>arm(eb)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/3174">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>arm(eb)-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23763">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>arm-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23773">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>hexagon-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21652">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>loongarch64-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21646">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>mips(el)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/3345">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>mips(el)-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23764">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>mips64(el)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21647">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>mips64(el)-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23774">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>powerpc-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21649">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>powerpc-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23766">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>powerpc-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23775">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>powerpc64(le)-freebsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23678">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>powerpc64(le)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21651">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>⚠️</td>
...
<tr>
<td><code>powerpc64-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23776">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>riscv32-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21648">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>riscv64-freebsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23676">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>riscv64-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/4456">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>riscv64-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23777">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>s390x-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/21402">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>thumb(eb)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23672">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>thumb-windows</code></td>
<td><a href="https://github.com/ziglang/zig/issues/24017">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<td><a href="https://github.com/ziglang/zig/issues/23091">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>x86-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/1929">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>x86-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23772">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>x86-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23778">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>x86-windows</code></td>
<td><a href="https://github.com/ziglang/zig/issues/537">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>x86_64-freebsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/1759">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>x86_64-maccatalyst</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25933">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted">⚡</span></td>
...
<td><a href="https://github.com/ziglang/zig/issues/4897">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted">⚡</span></td>
...
<tr>
<td><code>x86_64-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23082">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>x86_64-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/2016">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<td><a href="https://github.com/ziglang/zig/issues/23080">2</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23755">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<td><a href="https://github.com/ziglang/zig/issues/23782">3</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-serenity</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23686">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-tvos</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23784">3</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-visionos</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23786">3</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>aarch64-watchos</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23788">3</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>arm-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23756">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>loongarch32-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23696">3</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>mips64(el)-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23765">3</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>riscv64-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23759">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>riscv64-serenity</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23687">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>wasm64-wasi</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23092">3</a></td>
<td>❔</td>
<td>❌️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>x86-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23761">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>x86-illumos</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23689">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span></td>
<td>✅</td>
...
<tr>
<td><code>x86_64-dragonfly</code></td>
<td><a href="https://github.com/ziglang/zig/issues/7149">3</a></td>
<td>✅</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>x86_64-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/7691">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted">⚡</span></td>
...
<tr>
<td><code>x86_64-illumos</code></td>
<td><a href="https://github.com/ziglang/zig/issues/7152">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>x86_64-serenity</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23688">3</a></td>
<td>✅</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted">⚡</span></td>
...
<tr>
<td><code>alpha-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25671">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
<td>❌️</td>
<td>❌️</td>
<td>❌️</td>
...
<tr>
<td><code>alpha-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25673">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>alpha-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25676">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>arc(eb)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23086">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="Assembly Code">📄</span></td>
<td>❌️</td>
<td>✅</td>
<td>✅</td>
<td>❌️</td>
...
<tr>
<td><code>csky-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23087">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="Assembly Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>hppa-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25672">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>hppa-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25674">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>hppa-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25677">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>hppa64-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/26063">4</a></td>
<td>❔</td>
<td>❌️</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>m68k-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23757">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span></td>
<td>❌️</td>
...
<tr>
<td><code>m68k-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23089">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>❌️</td>
...
<tr>
<td><code>m68k-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23090">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>❌️</td>
...
<tr>
<td><code>m88k-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/26065">4</a></td>
<td>❔</td>
<td>❌️</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>microblaze(el)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25670">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>or1k-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/26064">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>sh(eb)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25669">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>sh(eb)-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25675">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>sh-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/25678">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="C Code">📄</span></td>
<td>❌️</td>
...
<tr>
<td><code>sparc-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23081">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span></td>
<td>❌️</td>
...
<tr>
<td><code>sparc-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23770">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span></td>
<td>❌️</td>
...
<tr>
<td><code>sparc64-haiku</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23760">4</a></td>
<td>❔</td>
<td>⚠️</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>sparc64-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/4931">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>sparc64-netbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23771">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>sparc64-openbsd</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23779">4</a></td>
<td>❔</td>
<td>✅</td>
<td><span title="Machine Code">🖥️</span><span
title="Self-Hosted In Development">🛠️</span></td>
...
<tr>
<td><code>xtensa(eb)-linux</code></td>
<td><a href="https://github.com/ziglang/zig/issues/23081">4</a></td>
<td>❔</td>
<td>❌️</td>
<td><span title="Assembly Code">📄</span></td>
...
### [OS Version Requirements](release-notes.html#toc-OS-Version-Requirements) <a href="release-notes.html#OS-Version-Requirements" class="hdr">§</a>
...
### [Additional Platforms](release-notes.html#toc-Additional-Platforms) <a href="release-notes.html#Additional-Platforms" class="hdr">§</a>
...
## [Language Changes](release-notes.html#toc-Language-Changes) <a href="release-notes.html#Language-Changes" class="hdr">§</a>

### [switch](release-notes.html#toc-switch) <a href="release-notes.html#switch" class="hdr">§</a>

<img src="../../img/Carmen_4.svg" style="height: 18em; float: right"
alt="Carmen the Allocgator" />

<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`struct`</span>
and
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`union`</span>
may now be used as switch prong items. They are compared solely based on
their backing integer, just like in equality comparisons:
...
- decl literals and everything else requiring a result type (e.g.
  <span class="tok-builtin">`@enumFromInt`</span>) may now be used as
  switch prong items
- union tag captures are now allowed for all prongs, not just
  <span class="tok-kw">`inline`</span> ones
...
- lots of issues with switching on one-possible-value types are now
  fixed
- the rules around unreachable <span class="tok-kw">`else`</span> prongs
  when switching on errors now apply to *any* switch on an error, not
  just to `switch_block_err_union`, and are applied properly based on
  the AST
- switching on <span class="tok-type">`void`</span> no longer requires
  an <span class="tok-kw">`else`</span> prong unconditionally
...
### [Equality Comparisons on Packed Unions](release-notes.html#toc-Equality-Comparisons-on-Packed-Unions) <a href="release-notes.html#Equality-Comparisons-on-Packed-Unions"
class="hdr">§</a>
...
into a
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`struct`</span>.
Now it's also possible without having to do that.

### [@cImport Moving to Build System](release-notes.html#toc-cImport-Moving-to-Build-System) <a href="release-notes.html#cImport-Moving-to-Build-System"
class="hdr">§</a>

In the future, [C Translation](release-notes.html#C-Translation) will be
handled via the [Build System](release-notes.html#Build-System) rather
than the <span class="tok-builtin">`@cImport`</span> language builtin,
...
before with <span class="tok-builtin">`@cImport`</span>.
...
### [@Type Replaced with Individual Type-Creating Builtin Functions](release-notes.html#toc-Type-Replaced-with-Individual-Type-Creating-Builtin-Functions) <a
href="release-notes.html#Type-Replaced-with-Individual-Type-Creating-Builtin-Functions"
class="hdr">§</a>

Zig 0.16.0 implements long-accepted proposal
[\#10710](https://github.com/ziglang/zig/issues/10710) to remove the
<span class="tok-builtin">`@Type`</span> builtin from the language and
replace it with individual builtins like
<span class="tok-builtin">`@Int`</span> and
<span class="tok-builtin">`@Struct`</span>. While
<span class="tok-builtin">`@Type`</span> is a simple parallel to
<span class="tok-builtin">`@typeInfo`</span>, in practice, it was clunky
to use for common tasks, leading users to reach for helpers like
`std.meta.Int`. Ignoring <span class="tok-builtin">`@Vector`</span>,
which already existed, <span class="tok-builtin">`@Type`</span> has been
replaced with 8 new builtin functions:
...
<span class="tok-builtin">`@EnumLiteral`</span>`()` returns the "enum
literal" type, which is the type of uncoerced enum literals like `.foo`.
While it is equivalent to
<span class="tok-builtin">`@TypeOf`</span>`(.something)`, the new
<span class="tok-builtin">`@EnumLiteral`</span>`()` is preferred for
consistency.
...
<span class="tok-builtin">`@Int`</span> is perhaps the most useful new
builtin for simple metaprogramming. The usage is equivalent to the
now-deprecated `std.meta.Int` helper: given a signedness and bit count,
it returns an integer type with those properties. This new usage results
in significantly more concise and readable code.
...
<span class="tok-builtin">`@Tuple`</span> is equivalent to the
now-deprecated `std.meta.Tuple` helper. It accepts a slice of types, and
returns a tuple type whose fields have those types.
...
with <span class="tok-kw">`comptime`</span> fields.

#### Pointer

<span class="tok-builtin">`@Pointer`</span> returns a pointer type,
equivalent to
<span class="tok-builtin">`@Type`</span>`(.{ .pointer = ... })`.
Notably, it uses the new `std.builtin.Type.Pointer.Attributes` type,
...
<span class="tok-builtin">`@Fn`</span> returns a function type,
equivalent to
<span class="tok-builtin">`@Type`</span>`(.{ .@"fn" = ... })`. Like for
pointers, new helper types have been introduced to make this builtin
simpler to use. Parameters are specified with two separate arguments:
the first specifies all parameter types, and the second specifies
"attributes" (which currently consist only of the
<span class="tok-kw">`noalias`</span> flag).
...
"struct of arrays" style. An advantage of this style is that it makes it
easy to specify a fixed value for all elements. For instance, to use the
"default" attributes `.{}` for all parameters, use
`&`<span class="tok-builtin">`@splat`</span>`(.{})`:

    @Fn(param_types, &@splat(.{}), ReturnType, .{ .@"callconv" = .c })

#### Struct

<span class="tok-builtin">`@Struct`</span> returns a
<span class="tok-kw">`struct`</span> type, equivalent to
<span class="tok-builtin">`@Type`</span>`(.{ .@"struct" = ... })`. Like
<span class="tok-builtin">`@Fn`</span>, it uses a "struct of arrays"
strategy to pass information about fields. Fields are passed as three
separate arrays—field names, field types, and field attributes—where the
latter includes alignment, the <span class="tok-kw">`comptime`</span>
flag, and the field's default value (if any).
...
Again, `&`<span class="tok-builtin">`@splat`</span>`(.{})` is useful for
specifying "default" field attributes. In some cases, it is even useful
to use <span class="tok-builtin">`@splat`</span> for the field types.
For instance, to create a struct with homogeneous field types of
`FieldType` where the field names match the names of an enum type
`MyEnum`:
...
<span class="tok-builtin">`@Union`</span> returns a
<span class="tok-kw">`union`</span> type, equivalent to
<span class="tok-builtin">`@Type`</span>`(.{ .@"union" = ... })`. It is
quite similar to <span class="tok-builtin">`@Struct`</span> in usage.
...
<span class="tok-builtin">`@Enum`</span> returns an
<span class="tok-kw">`enum`</span> type, equivalent to
<span class="tok-builtin">`@Type`</span>`(.{ .@"enum" = ... })`. It is
somewhat similar to <span class="tok-builtin">`@Struct`</span> in usage,
but accepts an array of field \*tag values\* rather than field
\*types\*.
...
There is no <span class="tok-builtin">`@Float`</span> builtin, because
there are only 5 runtime floating-point types, so this functionality is
trivially implemented in userland. The function `std.meta.Float` can be
used if creating float types from a bit count is required.

#### Array

There is no <span class="tok-builtin">`@Array`</span> builtin, because
this functionality is trivial to implement with normal array syntax. A
general `Array` function would look like this:
...
There is no <span class="tok-builtin">`@Opaque`</span> builtin. Instead,
write <span class="tok-kw">`opaque`</span>` {}`.

#### Optional

There is no <span class="tok-builtin">`@Optional`</span> builtin.
Instead, write `?T`.

#### Error Union

There is no <span class="tok-builtin">`@ErrorUnion`</span> builtin.
Instead, write `E!T`.

#### Error Set

There is no <span class="tok-builtin">`@ErrorSet`</span> builtin. To
simplify the language, it is no longer possible to reify error sets.
Instead, declare your error sets explicitly using
<span class="tok-kw">`error`</span>`{ ... }` syntax.

### [Allow Small Integer Types to Coerce to Floats](release-notes.html#toc-Allow-Small-Integer-Types-to-Coerce-to-Floats) <a
href="release-notes.html#Allow-Small-Integer-Types-to-Coerce-to-Floats"
class="hdr">§</a>
...
<span class="tok-builtin">`@floatFromInt`</span>.
...
### [Forbid Runtime Vector Indexes](release-notes.html#toc-Forbid-Runtime-Vector-Indexes) <a href="release-notes.html#Forbid-Runtime-Vector-Indexes"
class="hdr">§</a>
...
Lowering](release-notes.html#Reworked-Byval-Syntax-Lowering).

### [Vectors and Arrays No Longer Support In-Memory Coercion](release-notes.html#toc-Vectors-and-Arrays-No-Longer-Support-In-Memory-Coercion) <a
href="release-notes.html#Vectors-and-Arrays-No-Longer-Support-In-Memory-Coercion"
class="hdr">§</a>

If you were using <span class="tok-builtin">`@ptrCast`</span> to convert
between array memory and vector memory, use coercion instead.

If you were coercing from
<span class="tok-type">`anyerror`</span>`![`<span class="tok-number">`4`</span>`]`<span class="tok-type">`i32`</span>
to
<span class="tok-type">`anyerror`</span>`!`<span class="tok-builtin">`@Vector`</span>`(`<span class="tok-number">`4`</span>`, `<span class="tok-type">`i32`</span>`)`
or similar, you need to unwrap the error first.

### [Forbid Trivial Local Address Returned from Functions](release-notes.html#toc-Forbid-Trivial-Local-Address-Returned-from-Functions) <a
href="release-notes.html#Forbid-Trivial-Local-Address-Returned-from-Functions"
class="hdr">§</a>
...
if the returned pointer is dereferenced. Even then, it's legal to have a
function that unconditionally invokes illegal behavior:
...
expression <span class="tok-kw">`unreachable`</span>.
...
with the justification that the expression should instead be written
canonically as
<span class="tok-kw">`return`</span>` `<span class="tok-null">`undefined`</span>.
...
### [Unary Float Builtins Forward Result Type](release-notes.html#toc-Unary-Float-Builtins-Forward-Result-Type) <a href="release-notes.html#Unary-Float-Builtins-Forward-Result-Type"
class="hdr">§</a>
...
since <span class="tok-builtin">`@sqrt`</span> would not forward the
<span class="tok-type">`f64`</span> result type to
<span class="tok-builtin">`@floatFromInt`</span>, now you can.

This is part of a larger effort to improve ergonomics for making video
games in Zig.

### [@floor, @ceil, @round, @trunc Conversion to Integers](release-notes.html#toc-floor-ceil-round-trunc-Conversion-to-Integers) <a
href="release-notes.html#floor-ceil-round-trunc-Conversion-to-Integers"
class="hdr">§</a>

<span class="tok-builtin">`@floor`</span>,
<span class="tok-builtin">`@ceil`</span>,
<span class="tok-builtin">`@round`</span>, and
<span class="tok-builtin">`@trunc`</span> now can be used to convert a
...
<span class="tok-builtin">`@intFromFloat`</span> is now redundant with
<span class="tok-builtin">`@trunc`</span> and is therefore deprecated.

This is part of a larger effort to improve ergonomics for making video
games in Zig.

### [Forbid Unused Bits in Packed Unions](release-notes.html#toc-Forbid-Unused-Bits-in-Packed-Unions) <a href="release-notes.html#Forbid-Unused-Bits-in-Packed-Unions"
class="hdr">§</a>
...
example,
<span class="tok-kw">`enum`</span>` (`<span class="tok-type">`u5`</span>`) { ... }`
plainly represents 5 bits in an obvious manner and is allowed in packed
contexts, but `?`<span class="tok-type">`u8`</span> has two reasonable
ways of mapping to 9 bits and is therefore not allowed in packed
contexts.

This ambiguity is resolved by requiring all fields of a packed union to
have the same <span class="tok-builtin">`@bitSizeOf`</span> as a backing
integer type.
...
### [Forbid Pointers in Packed Structs and Unions](release-notes.html#toc-Forbid-Pointers-in-Packed-Structs-and-Unions) <a
href="release-notes.html#Forbid-Pointers-in-Packed-Structs-and-Unions"
class="hdr">§</a>
...
and
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`union`</span>
types are no longer permitted to be pointers, implementing proposal
...
into an integer, as <span class="tok-kw">`packed`</span> types purport
to do.

If you were relying on pointers in <span class="tok-kw">`packed`</span>
types, you can instead use a <span class="tok-type">`usize`</span> field
and convert to and from a pointer using
<span class="tok-builtin">`@ptrFromInt`</span> and
<span class="tok-builtin">`@intFromPtr`</span>.

### [Allow Explicit Backing Integers on Packed Unions](release-notes.html#toc-Allow-Explicit-Backing-Integers-on-Packed-Unions) <a
href="release-notes.html#Allow-Explicit-Backing-Integers-on-Packed-Unions"
class="hdr">§</a>

Although previous versions of Zig allowed
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`struct`</span>
types to specify their backing integer type with the syntax
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`struct`</span>`(T)`,
this was not previously permitted for
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`union`</span>
types. In Zig 0.16.0, this has now been allowed.
...
Types in Extern
Contexts](release-notes.html#Forbid-Enum-and-Packed-Types-with-Implicit-Backing-Types-in-Extern-Contexts),
specifying a backing type like this is sometimes required.

### [Forbid Enum and Packed Types with Implicit Backing Types in Extern Contexts](release-notes.html#toc-Forbid-Enum-and-Packed-Types-with-Implicit-Backing-Types-in-Extern-Contexts) <a
href="release-notes.html#Forbid-Enum-and-Packed-Types-with-Implicit-Backing-Types-in-Extern-Contexts"
class="hdr">§</a>

<span class="tok-kw">`enum`</span> types with inferred integer tag
types, and
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`struct`</span>
and
<span class="tok-kw">`packed`</span>` `<span class="tok-kw">`union`</span>
types with inferred integer backing types, are no longer considered
valid <span class="tok-kw">`extern`</span> types. This implements
proposal [\#24714](https://github.com/ziglang/zig/issues/24714).
...
particular, this matters because <span class="tok-type">`u8`</span> and
<span class="tok-type">`i8`</span> may have differing ABIs in some
contexts, and it is not clear which is being used if the choice is
implicit.
...
Unions](release-notes.html#Allow-Explicit-Backing-Integers-on-Packed-Unions)
for a related language change in Zig 0.16.0.)
...
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:5:1: error: unable to export type &#39;extern_implicit_backing_type.Enum&#39;
export var some_enum: Enum = .a;
^~~~~~
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:1:14: note: integer tag type of enum is inferred
const Enum = enum { a, b, c, d };
             ^~~~~~~~~~~~~~~~~~~
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:1:14: note: consider explicitly specifying the integer tag type
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:1:14: note: enum declared here
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:6:1: error: unable to export type &#39;extern_implicit_backing_type.PackedStruct&#39;
export var some_packed_struct: PackedStruct = .{ .a = 1, .b = 2 };
^~~~~~
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:6:1: note: inferred backing integer of packed struct has unspecified signedness
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:2:29: note: struct declared here
const PackedStruct = packed struct { a: u4, b: u4 };
                     ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:7:1: error: unable to export type &#39;extern_implicit_backing_type.PackedUnion&#39;
export var some_packed_union: PackedUnion = .{ .a = 123 };
^~~~~~
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:7:1: note: inferred backing integer of packed union has unspecified signedness
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/extern_implicit_backing_type.zig:3:28: note: union declared here
const PackedUnion = packed union { a: u8, b: i8 };
                    ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~
</code></pre>
<figcaption>Shell</figcaption>
...
### [Lazy Field Analysis](release-notes.html#toc-Lazy-Field-Analysis) <a href="release-notes.html#Lazy-Field-Analysis" class="hdr">§</a>

<img src="../../img/Ziggy_11.svg" style="height: 9em; float: right"
alt="Ziggy the Ziguana" />

A problem we noticed since introducing [I/O as an
Interface](release-notes.html#IO-as-an-Interface) is that if a type is
used as a namespace, its fields will be analyzed anyway. For instance,
using `std.Io.Writer` in any way pulls in the vtable of `std.Io`. Some
cases of this could even result in unnecessary codegen, which can bloat
binaries.

Now, <span class="tok-kw">`struct`</span> (reminder that files are
structs), <span class="tok-kw">`union`</span>,
<span class="tok-kw">`enum`</span>, and
<span class="tok-kw">`opaque`</span> are only resolved when its size or
the type of one of its fields is required. This means that not only can
you use types as namespaces without referencing them, but you can even
use non-dereferenced pointers `*T` without needing `T` to be resolved.

This was changed as part of [Reworked Type
Resolution](release-notes.html#Reworked-Type-Resolution).

### [Pointers to Comptime-Only Types Are No Longer Comptime-Only](release-notes.html#toc-Pointers-to-Comptime-Only-Types-Are-No-Longer-Comptime-Only) <a
href="release-notes.html#Pointers-to-Comptime-Only-Types-Are-No-Longer-Comptime-Only"
class="hdr">§</a>

For instance, though <span class="tok-type">`comptime_int`</span> is a
comptime-only type, `*`<span class="tok-type">`comptime_int`</span> is
not, and neither is `[]`<span class="tok-type">`comptime_int`</span>.
This may seem confusing at first—the easiest way to understand it is to
consider function pointers. The type
`*`<span class="tok-kw">`const`</span>` `<span class="tok-kw">`fn`</span>` () `<span class="tok-type">`void`</span>
is a runtime type. However, you are not allowed to *dereference* it at
runtime, because the element type (the function body type
<span class="tok-kw">`fn`</span>` () `<span class="tok-type">`void`</span>)
is comptime-only. So these pointers can *exist* at runtime, but may only
be *dereferenced* at compile-time. This makes them more-or-less useless
at runtime—but there's actually an exception to that! Suppose you have a
`[]`<span class="tok-kw">`const`</span>` std.builtin.Type.StructField`,
and you want to pass the `name` of each field to runtime code somehow.
...
`StructField` from this slice at runtime. However, what it *can* do is
load the `name` field, because *it* has a runtime type!

This was changed as part of [Reworked Type
Resolution](release-notes.html#Reworked-Type-Resolution).

### [Explicitly-Aligned Pointer Types Now Distinct from Naturally-Aligned Pointer Types](release-notes.html#toc-Explicitly-Aligned-Pointer-Types-Now-Distinct-from-Naturally-Aligned-Pointer-Types) <a
href="release-notes.html#Explicitly-Aligned-Pointer-Types-Now-Distinct-from-Naturally-Aligned-Pointer-Types"
class="hdr">§</a>

Previously, `*`<span class="tok-type">`u8`</span> and
`*`<span class="tok-kw">`align`</span>`(`<span class="tok-number">`1`</span>`) `<span class="tok-type">`u8`</span>
were considered by Zig to be literally the same type; they would compare
equal, and `*`<span class="tok-type">`u8`</span> was considered the
canonical spelling (it's what the compiler would print). Now, those two
types are no longer considered equivalent.
...
like the difference between <span class="tok-type">`u32`</span> and
<span class="tok-type">`c_uint`</span>: technically they are different
types, but (assuming your target has 32-bit `int`) they act identically
for all intents and purposes, and it doesn't technically matter which
one you pick.

This was changed as part of [Reworked Type
Resolution](release-notes.html#Reworked-Type-Resolution).

### [Simplified Dependency Loop Rules](release-notes.html#toc-Simplified-Dependency-Loop-Rules) <a href="release-notes.html#Simplified-Dependency-Loop-Rules"
class="hdr">§</a>
...
### [Zero-bit Tuple Fields No Longer Implicitly comptime](release-notes.html#toc-Zero-bit-Tuple-Fields-No-Longer-Implicitly-comptime) <a
href="release-notes.html#Zero-bit-Tuple-Fields-No-Longer-Implicitly-comptime"
class="hdr">§</a>

Back in 0.14.0, a rule was unintentionally introduced that tuple fields
with zero-bit types are implicitly promoted to
<span class="tok-kw">`comptime`</span> fields:
...
considered a <span class="tok-kw">`comptime`</span> field. However, this
does \*not\* prevent the field value from always being comptime-known:
...
`std.builtin.StructField.is_comptime` from
<span class="tok-builtin">`@typeInfo`</span>, or on the equivalence of
tuples with and without explicitly declared
<span class="tok-kw">`comptime`</span> fields:
...
## [Standard Library](release-notes.html#toc-Standard-Library) <a href="release-notes.html#Standard-Library" class="hdr">§</a>
...
- <span class="tok-kw">`error`</span>`.RenameAcrossMountPoints` ➡️
  <span class="tok-kw">`error`</span>`.CrossDevice`
- <span class="tok-kw">`error`</span>`.NotSameFileSystem` ➡️
  <span class="tok-kw">`error`</span>`.CrossDevice`
- <span class="tok-kw">`error`</span>`.SharingViolation` ➡️
  <span class="tok-kw">`error`</span>`.FileBusy`
- <span class="tok-kw">`error`</span>`.EnvironmentVariableNotFound` ➡️
  <span class="tok-kw">`error`</span>`.EnvironmentVariableMissing`
- `std.Io.Dir.rename` returns
  <span class="tok-kw">`error`</span>`.DirNotEmpty` rather than
...
### [I/O as an Interface](release-notes.html#toc-IO-as-an-Interface) <a href="release-notes.html#IO-as-an-Interface" class="hdr">§</a>

<img src="../../img/Zero_14.svg" style="height: 14em; float: right"
alt="Zero the Ziguana" />
...
- `Io.Threaded` - based on threads. With this implementation, I/O
  ...
  System](release-notes.html#File-System) operations directly call read,
  write, open, close, etc. When updating code from Zig 0.15.x, using
  this implementation provides the equivalent behavior. **This
  implementation is feature-complete and well-tested**, including
  [Cancelation](release-notes.html#Cancelation). This is the
  implementation currently chosen by ["Juicy
  Main"](release-notes.html#Juicy-Main).
...
- `Io.Evented` - **work-in-progress, experimental**, serving to inform
  ...
  - `Io.Uring` - although it was not the focus of this release cycle,
    ...
    it's not finished yet. It's lacking
    [Networking](release-notes.html#Networking), error handling, test
...
- [Future](release-notes.html#Future) - task-level abstraction based on
  functions. Allows introducing operational independence
  (**asynchrony**) among any set of function calls.
- [Group](release-notes.html#Group) - efficiently manages many
  independent tasks. Supports awaiting and
  [canceling](release-notes.html#Cancelation) all tasks in the group
  together.
...
- `Select` - executes tasks together, providing a mechanism to wait
  until one or more tasks complete. Similar to
  [Batch](release-notes.html#Batch) but operates at the higher level
  task abstraction layer rather than lower level `Operation` abstraction
  layer.
- [Batch](release-notes.html#Batch) - lower level abstraction based on
  introducing independence among any set of **operations**.
...
- Upon the first successful TCP connection, all other in-flight
  connection attempts are [canceled](release-notes.html#Cancelation),
...
- [On Windows, this all happens without ws2_32.dll
  dependency.](release-notes.html#Windows-Networking-Without-ws2_32dll)

`init: std.process.Init` is thanks to ["Juicy
Main"](release-notes.html#Juicy-Main).
...
when you need an `Allocator` and do not have one. Instead, it is better
to accept an `Io` parameter if you need one (or store one on a context
struct for convenience). Point is that the application's `main` function
should generally be responsible for constructing the `Io` instance used
throughout.

When testing, it is recommended to use `std.testing.io` (much like
`std.testing.allocator`).

#### [Future](release-notes.html#toc-Future) <a href="release-notes.html#Future" class="hdr">§</a>
...
<span class="tok-kw">`error`</span>`.ConcurrencyUnavailable`.
...
- `cancel` - equivalent to `await` except also requests the `Io`
  ...
  <span class="tok-kw">`error`</span>`.Canceled`. Most I/O operations
  now have <span class="tok-kw">`error`</span>`.Canceled` in their error
  sets.

Use this pattern to avoid resource leaks and handle
[Cancelation](release-notes.html#Cancelation) gracefully:
...
freed, then the <span class="tok-kw">`if`</span> can be simplified to
`_ = foo.cancel(io) `<span class="tok-kw">`catch`</span>` {}`, and if
the function returns <span class="tok-type">`void`</span>, then the
discard can also be removed. The `cancel` is necessary however because
it releases the async task resource when errors (including
<span class="tok-kw">`error`</span>`.Canceled`) are returned.

#### [Group](release-notes.html#toc-Group) <a href="release-notes.html#Group" class="hdr">§</a>
...
#### [Cancelation](release-notes.html#toc-Cancelation) <a href="release-notes.html#Cancelation" class="hdr">§</a>
...
[Future](release-notes.html#Future), [Group](release-notes.html#Group),
and [Batch](release-notes.html#Batch) APIs all support requesting
cancelation. When cancelation is requested, the request may or may not
be acknowledged. Acknowledged cancelation requests cause I/O operations
to return <span class="tok-kw">`error`</span>`.Canceled`. Even
`Io.Threaded` supports cancelation by sending a signal to a thread,
causing blocking syscalls to return `EINTR`, and responding to that
error code by checking for a cancelation request before retrying the
syscall.

Only the logic that made the cancelation request can soundly ignore an
<span class="tok-kw">`error`</span>`.Canceled`. Otherwise, there are
three ways to handle <span class="tok-kw">`error`</span>`.Canceled`. In
...
useful pattern is to <span class="tok-kw">`defer`</span> a cancelation
after creating a task. This ensures the resources, including the
concurrent tasks, are deallocated before returning from the function.

Generally, Zig programmers don't need to explicitly add code to support
cancelation, because <span class="tok-kw">`error`</span>`.Canceled` is
baked into the error sets of all the cancelable I/O operations. However,
one can add additional cancelation points by calling `io.checkCancel`.
It is rarely necessary to call this function. The primary use case is in
long-running CPU-bound tasks which may need to respond to cancelation
before completing.

#### [Batch](release-notes.html#toc-Batch) <a href="release-notes.html#Batch" class="hdr">§</a>
...
Eventually most of the [File System](release-notes.html#File-System) and
[Networking](release-notes.html#Networking) functionality are expected
to migrate to become based on `Operation`, making them eligible to be
used with `Batch`, and eligible to be used with `operateTimeout`, which
provides a general way to add a timeout to *any* I/O operation.
...
Meanwhile [Future](release-notes.html#Future) is the equivalent but at a
*function* abstraction layer, which is flexible and ergonomic, but it
allocates task memory and
<span class="tok-kw">`error`</span>`.ConcurrencyUnavailable` (when using
...
once, otherwise, you can always use the
[Future](release-notes.html#Future) APIs if that would essentially
require you to reinvent futures. Or you can start with
[Future](release-notes.html#Future) APIs and then optimize by reworking
some stuff to use `Batch` later if reducing task overhead is desirable.

#### [Sync Primitives](release-notes.html#toc-Sync-Primitives) <a href="release-notes.html#Sync-Primitives" class="hdr">§</a>
...
I/O implementation. This will ensure, for example, when using
`std.Io.Threaded`, a contended mutex lock will block the thread, while
when using `std.Io.Evented`, it will switch stacks.

These APIs also integrate properly with
[Cancelation](release-notes.html#Cancelation).
...
#### [Entropy](release-notes.html#toc-Entropy) <a href="release-notes.html#Entropy" class="hdr">§</a>
...
#### [Time](release-notes.html#toc-Time) <a href="release-notes.html#Time" class="hdr">§</a>

This release adds the ability to get clock resolution, which may fail.
This allows <span class="tok-kw">`error`</span>`.Unexpected` and
<span class="tok-kw">`error`</span>`.ClockUnsupported` to be removed
from timeout and clock reading error sets because they can be treated as
having a resolution of infinite, which is detectable by the user by
separately (beforehand) calling `Clock.resolution`.
...
#### [File System](release-notes.html#toc-File-System) <a href="release-notes.html#File-System" class="hdr">§</a>
...
#### [Networking](release-notes.html#toc-Networking) <a href="release-notes.html#Networking" class="hdr">§</a>
...
#### [Process](release-notes.html#toc-Process) <a href="release-notes.html#Process" class="hdr">§</a>
...
#### [File.MemoryMap](release-notes.html#toc-FileMemoryMap) <a href="release-notes.html#FileMemoryMap" class="hdr">§</a>
...
now get <span class="tok-kw">`error`</span>`.IsDir` correctly instead of
<span class="tok-kw">`error`</span>`.NotOpenForReading`.

#### [posix and os.windows removals](release-notes.html#toc-posix-and-oswindows-removals) <a href="release-notes.html#posix-and-oswindows-removals"
class="hdr">§</a>
...
### [heap.ArenaAllocator Becomes Thread-Safe and Lock-Free](release-notes.html#toc-heapArenaAllocator-Becomes-Thread-Safe-and-Lock-Free) <a
href="release-notes.html#heapArenaAllocator-Becomes-Thread-Safe-and-Lock-Free"
class="hdr">§</a>

Lock-free and thread-safe plays better with [std.Io
integration](release-notes.html#IO-as-an-Interface) and libc
integration. By avoiding locks, we avoid needing [Sync
Primitives](release-notes.html#Sync-Primitives) and thereby avoid
needing an `Io` instance, and also allow the `Allocator` to be used as
the backing allocator for an `Io` instance.
...
### [heap.ThreadSafe Allocator Removed](release-notes.html#toc-heapThreadSafe-Allocator-Removed) <a href="release-notes.html#heapThreadSafe-Allocator-Removed"
class="hdr">§</a>
...
### [Add Deflate Compression, Simplify Decompression](release-notes.html#toc-Add-Deflate-Compression-Simplify-Decompression) <a
href="release-notes.html#Add-Deflate-Compression-Simplify-Decompression"
class="hdr">§</a>
...
#### [Zlib Comparison](release-notes.html#toc-Zlib-Comparison) <a href="release-notes.html#Zlib-Comparison" class="hdr">§</a>
...
### [Expanded target support for segfault handling/unwinding](release-notes.html#toc-Expanded-target-support-for-segfault-handlingunwinding) <a
href="release-notes.html#Expanded-target-support-for-segfault-handlingunwinding"
class="hdr">§</a>
...
experience if the other callers aren't resolved. Error return traces now
include inline callers on all platforms.

This is part of a larger effort to improve the use case of making video
games in Zig.

### [Removal of ucontext_t and related types/functions](release-notes.html#toc-Removal-of-ucontext_t-and-related-typesfunctions) <a
href="release-notes.html#Removal-of-ucontext_t-and-related-typesfunctions"
class="hdr">§</a>
...
### [Debug Information Reworked](release-notes.html#toc-Debug-Information-Reworked) <a href="release-notes.html#Debug-Information-Reworked"
class="hdr">§</a>

<img src="../../img/Zero_8.svg" style="height: 13em; float: right"
alt="Zero the Ziguana" />
...
longer <span class="tok-kw">`pub`</span>. If you were previously using
it, consider whether `captureCurrentStackTrace` is suitable for your
...
<span class="tok-builtin">`@import`</span>`(`<span class="tok-str">`"root"`</span>`).debug.SelfInfo`.
This allows stack traces to be made functional on targets which the Zig
Standard Library does not support—even freestanding ones!

### [Inter-Process Progress Reporting for Windows](release-notes.html#toc-Inter-Process-Progress-Reporting-for-Windows) <a
href="release-notes.html#Inter-Process-Progress-Reporting-for-Windows"
class="hdr">§</a>
...
### [Windows Networking Without ws2_32.dll](release-notes.html#toc-Windows-Networking-Without-ws2_32dll) <a href="release-notes.html#Windows-Networking-Without-ws2_32dll"
class="hdr">§</a>

All networking API on Windows now is implemented via direct AFD access.

This fixes a handful of bugs, makes
[Cancelation](release-notes.html#Cancelation) and
[Batch](release-notes.html#Batch) work properly for networking
operations, and avoids the performance pitfalls that exist within
ws2_32.dll's implementation of networking, such as maintaining an
entirely unnecessary hash table for side data attached to socket handles
that requires allocation and synchronization, rather than simply passing
socket mode and protocol to the accept function.

### [Completed Migration to NtDll](release-notes.html#toc-Completed-Migration-to-NtDll) <a href="release-notes.html#Completed-Migration-to-NtDll"
class="hdr">§</a>
...
Notably the [Batch](release-notes.html#Batch) API and
[Cancelation](release-notes.html#Cancelation) have full Windows support
...
implementation](release-notes.html#IO-as-an-Interface) that eschews
NtDll.

There are no plans to migrate away from using the above listed
functions.

### ["Juicy Main"](release-notes.html#toc-Juicy-Main) <a href="release-notes.html#Juicy-Main" class="hdr">§</a>
...
info: arg[2] = like
info: arg[3] = cheese
info: 97 env vars</code></pre>
<figcaption>Shell</figcaption>
</figure>

The first parameter of
<span class="tok-kw">`pub`</span>` `<span class="tok-kw">`fn`</span>` `<span class="tok-fn">`main`</span>
...
### [Environment Variables and Process Arguments Become Non-Global](release-notes.html#toc-Environment-Variables-and-Process-Arguments-Become-Non-Global) <a
href="release-notes.html#Environment-Variables-and-Process-Arguments-Become-Non-Global"
class="hdr">§</a>
...
`*`<span class="tok-kw">`const`</span>` process.Environ.Map` parameter.
An instance of this environment variable map can be obtained
conveniently from ["Juicy Main"](release-notes.html#Juicy-Main).
...
### [mem: introduce cut functions; rename "index of" to "find"](release-notes.html#toc-mem-introduce-cut-functions-rename-index-of-to-find) <a
href="release-notes.html#mem-introduce-cut-functions-rename-index-of-to-find"
class="hdr">§</a>
...
### [Selectively Walking Directory Trees](release-notes.html#toc-Selectively-Walking-Directory-Trees) <a href="release-notes.html#Selectively-Walking-Directory-Trees"
class="hdr">§</a>
...
### [fs.path Windows Paths](release-notes.html#toc-fspath-Windows-Paths) <a href="release-notes.html#fspath-Windows-Paths" class="hdr">§</a>
...
### [fs.path.relative Became Pure](release-notes.html#toc-fspathrelative-Became-Pure) <a href="release-notes.html#fspathrelative-Became-Pure"
class="hdr">§</a>
...
### [File.Stat: Make Access Time Optional](release-notes.html#toc-FileStat-Make-Access-Time-Optional) <a href="release-notes.html#FileStat-Make-Access-Time-Optional"
class="hdr">§</a>
...
### ["Preopens"](release-notes.html#toc-Preopens) <a href="release-notes.html#Preopens" class="hdr">§</a>
...
Or simply get them from ["Juicy Main"](release-notes.html#Juicy-Main)
via `std.Process.Init.preopens`.

Data is <span class="tok-type">`void`</span> on non-WASI systems; you
don't pay for it if you don't use it. However, this API is future proof
in case other operating systems add equivalent functionality.

### [Atomic/Temporary Files](release-notes.html#toc-AtomicTemporary-Files) <a href="release-notes.html#AtomicTemporary-Files" class="hdr">§</a>
...
`O_TMPFILE` on Linux. I'd like to take the opportunity to complain about
this API. First of all, it's almost very good. It gives the ability to
create an ephemeral, unnamed file descriptor, which one can operate on
freely until ready to materialize it onto the file system. If the
process terminates before it gets around to doing that, the OS garbage
collects the file, rather than leaving temporary, insecure trash around.
Brilliant! Unfortunately, due to multiple bugs and a debilitating design
limitation, the API is nearly useless.
...
<span class="tok-kw">`error`</span>`.PathAlreadyExists` when the
destination path already exists. Think about it, if you deleted the file
to make room, then it wouldn't be atomic any more!
...
### [Memory Locking and Protection API Moved to process](release-notes.html#toc-Memory-Locking-and-Protection-API-Moved-to-process) <a
href="release-notes.html#Memory-Locking-and-Protection-API-Moved-to-process"
class="hdr">§</a>
...
### [Current Directory API Renamed](release-notes.html#toc-Current-Directory-API-Renamed) <a href="release-notes.html#Current-Directory-API-Renamed"
class="hdr">§</a>
...
### [Migration to "Unmanaged" Containers](release-notes.html#toc-Migration-to-Unmanaged-Containers) <a href="release-notes.html#Migration-to-Unmanaged-Containers"
class="hdr">§</a>
...
- [PriorityDequeue](release-notes.html#PriorityDequeue) no longer has an
  `Allocator` field.
- [PriorityQueue](release-notes.html#PriorityQueue) no longer has an
  `Allocator` field.
...
### [PriorityDequeue](release-notes.html#toc-PriorityDequeue) <a href="release-notes.html#PriorityDequeue" class="hdr">§</a>
...
### [PriorityQueue](release-notes.html#toc-PriorityQueue) <a href="release-notes.html#PriorityQueue" class="hdr">§</a>
...
### [Thread.Pool Removed](release-notes.html#toc-ThreadPool-Removed) <a href="release-notes.html#ThreadPool-Removed" class="hdr">§</a>
...
[new std.Io interface](release-notes.html#IO-as-an-Interface).
...
### [Remove builtin.subsystem](release-notes.html#toc-Remove-builtinsubsystem) <a href="release-notes.html#Remove-builtinsubsystem" class="hdr">§</a>
...
subsystem won't be known until at link time, so it doesn't make sense to
try to determine it at compile time.
...
### [Move Target.SubSystem to zig.Subsystem and update field names](release-notes.html#toc-Move-TargetSubSystem-to-zigSubsystem-and-update-field-names) <a
href="release-notes.html#Move-TargetSubSystem-to-zigSubsystem-and-update-field-names"
class="hdr">§</a>
...
### [Io: delete GenericReader, AnyReader, FixedBufferStream](release-notes.html#toc-Io-delete-GenericReader-AnyReader-FixedBufferStream) <a
href="release-notes.html#Io-delete-GenericReader-AnyReader-FixedBufferStream"
class="hdr">§</a>
...
### [Replace {D} format specifier with Io.Duration format method](release-notes.html#toc-Replace-D-format-specifier-with-IoDuration-format-method) <a
href="release-notes.html#Replace-D-format-specifier-with-IoDuration-format-method"
class="hdr">§</a>
...
### [fs.getAppDataDir Removed](release-notes.html#toc-fsgetAppDataDir-Removed) <a href="release-notes.html#fsgetAppDataDir-Removed" class="hdr">§</a>
...
### [Io.Writer.Allocating Alignment Field](release-notes.html#toc-IoWriterAllocating-Alignment-Field) <a href="release-notes.html#IoWriterAllocating-Alignment-Field"
class="hdr">§</a>
...
### [fs.Dir.readFileAlloc](release-notes.html#toc-fsDirreadFileAlloc) <a href="release-notes.html#fsDirreadFileAlloc" class="hdr">§</a>
...
### [fs.File.readToEndAlloc](release-notes.html#toc-fsFilereadToEndAlloc) <a href="release-notes.html#fsFilereadToEndAlloc" class="hdr">§</a>
...
### [std.crypto: add AES-SIV and AES-GCM-SIV](release-notes.html#toc-stdcrypto-add-AES-SIV-and-AES-GCM-SIV) <a href="release-notes.html#stdcrypto-add-AES-SIV-and-AES-GCM-SIV"
class="hdr">§</a>
...
### [std.crypto: add Ascon-AEAD, Ascon-Hash, Ascon-CHash](release-notes.html#toc-stdcrypto-add-Ascon-AEAD-Ascon-Hash-Ascon-CHash) <a
href="release-notes.html#stdcrypto-add-Ascon-AEAD-Ascon-Hash-Ascon-CHash"
class="hdr">§</a>
...
## [Build System](release-notes.html#toc-Build-System) <a href="release-notes.html#Build-System" class="hdr">§</a>

Uncategorized changes:

- std.Build.Step.ConfigHeader: handle leading whitespace for cmake

### [Ability to Override Packages Locally](release-notes.html#toc-Ability-to-Override-Packages-Locally) <a href="release-notes.html#Ability-to-Override-Packages-Locally"
class="hdr">§</a>

<img src="../../img/Carmen_9.svg" style="height: 12em; float: right"
alt="Carmen the Allocgator" />
...
### [Fetch Packages Into Project-Local Directory](release-notes.html#toc-Fetch-Packages-Into-Project-Local-Directory) <a href="release-notes.html#Fetch-Packages-Into-Project-Local-Directory"
class="hdr">§</a>

Instead of being fetched into `$GLOBAL_ZIG_CACHE/p/$HASH`, package
dependencies are now fetched into a "zig-pkg" directory relative to the
build root (next to `build.zig`). Users are generally encouraged to not
commit these files to source control, however it is understood that some
will choose to do so for convenience.
...
### [Unit Test Timeouts](release-notes.html#toc-Unit-Test-Timeouts) <a href="release-notes.html#Unit-Test-Timeouts" class="hdr">§</a>

It is now possible to specify a timeout to apply to all individual Zig
unit tests (i.e. <span class="tok-kw">`test`</span> blocks). Using the
...
### [Added `--error-style` Flag](release-notes.html#toc-Added-code--error-stylecode-Flag) <a href="release-notes.html#Added-code--error-stylecode-Flag"
class="hdr">§</a>
...
Compilation](release-notes.html#Incremental-Compilation).
...
### [Added `--multiline-errors` Flag](release-notes.html#toc-Added-code--multiline-errorscode-Flag) <a href="release-notes.html#Added-code--multiline-errorscode-Flag"
class="hdr">§</a>
...
### [Temporary Files API](release-notes.html#toc-Temporary-Files-API) <a href="release-notes.html#Temporary-Files-API" class="hdr">§</a>
...
## [Compiler](release-notes.html#toc-Compiler) <a href="release-notes.html#Compiler" class="hdr">§</a>

### [C Translation](release-notes.html#toc-C-Translation) <a href="release-notes.html#C-Translation" class="hdr">§</a>
...
<span class="tok-builtin">`@cImport`</span> is encountered. [In the
future, Zig will drop the @cImport language
builtin](release-notes.html#cImport-Moving-to-Build-System), but for now
it remains, backed by Aro instead of Clang.
...
### [LLVM Backend](release-notes.html#toc-LLVM-Backend) <a href="release-notes.html#LLVM-Backend" class="hdr">§</a>
...
debuggers to understand which field is "active" and only show that one.
Unfortunately, while GDB supports this feature, LLDB does not, and fails
to print the type's fields whatsoever when variant types are used.
(Bizarrely, LLDB *does* have partial support, but [it's only enabled
when the language is marked as
...
Compared to the [x86 Backend](release-notes.html#x86-Backend), the LLVM
backend is passing 2004/2010 (100%) of the behavior tests.

### [Reworked Byval Syntax Lowering](release-notes.html#toc-Reworked-Byval-Syntax-Lowering) <a href="release-notes.html#Reworked-Byval-Syntax-Lowering"
class="hdr">§</a>
...
emitted in the pipeline, by lowering expressions with "byval" semantics.
The experiment was a failure, because it lead to the following issues:
...
The frontend now lowers expressions "byref" until the final load, fixing
all of those issues.

[more details](https://github.com/ziglang/zig/pull/25154)

### [Reworked Type Resolution](release-notes.html#toc-Reworked-Type-Resolution) <a href="release-notes.html#Reworked-Type-Resolution" class="hdr">§</a>
...
/home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/struct_uses_own_alignment.zig:2:28: error: type &#39;struct_uses_own_alignment.S&#39; depends on itself for alignment query here
    foo: [*]align(@alignOf(@This())) u8,
                           ^~~~~~~
</code></pre>
<figcaption>Shell</figcaption>
...
error: dependency loop with length 3
    /home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/complex_dependency_loop.zig:6:29: note: default field value of &#39;complex_dependency_loop.S&#39; uses value of declaration &#39;complex_dependency_loop.default_val&#39; here
    const S = struct { x: u32 = default_val };
                                ^~~~~~~~~~~
    /home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/complex_dependency_loop.zig:7:21: note: value of declaration &#39;complex_dependency_loop.default_val&#39; uses value of declaration &#39;complex_dependency_loop.other_val&#39; here
    const default_val = other_val;
                        ^~~~~~~~~
    /home/ci/.cache/act/df70bf0fcedde89f/hostexecutor/src/download/0.16.0/release-notes/complex_dependency_loop.zig:8:19: note: value of declaration &#39;complex_dependency_loop.other_val&#39; uses default field values of &#39;complex_dependency_loop.S&#39; here
...
### [Incremental Compilation](release-notes.html#toc-Incremental-Compilation) <a href="release-notes.html#Incremental-Compilation" class="hdr">§</a>

<img src="../../img/Carmen_10.svg" style="height: 16em; float: right"
alt="Carmen the Allocgator" />
...
- Incremental updates have been made significantly faster by avoiding
  ...
  Resolution](release-notes.html#Reworked-Type-Resolution) making the
  compiler's internal dependency graph acyclic (except in the case of
  dependency loops).
- Incremental compilation no longer triggers "dependency loop" compile
  ...
  part of [Reworked Type
  Resolution](release-notes.html#Reworked-Type-Resolution).
- When using a self-hosted backend targeting ELF, the [New ELF
  Linker](release-notes.html#New-ELF-Linker) is now enabled by default,
  which is faster and has much more stable support for incremental
  compilation. This linker is not yet feature-complete—see [New ELF
  Linker](release-notes.html#New-ELF-Linker) for details.
- General stability has greatly improved—crashes and miscompilations in
  incremental updates are far less common than in previous versions of
  Zig.
- The [LLVM Backend](release-notes.html#LLVM-Backend) now supports
  incremental compilation. **This does not speed up the "LLVM Emit
  Object" phase of compilation:** that step is entirely LLVM's
  responsibility and there is little we can do to speed it up. However,
  it does speed up the building of LLVM bitcode in the Zig compiler.
  This also means that in cases where your code emits compilation
  errors, you can get near-instant feedback even with the LLVM backend
  (since "LLVM Emit Object" is skipped when compile errors exist).

Incremental compilation [still has known bugs, including some
miscompilations](release-notes.html#This-Release-Contains-Bugs), and
therefore remains disabled by default in 0.16.0. **Despite this, we
still encourage enabling it.** Users are frequently surprised by just
how much time they can save even just with near-instant compile error
feedback, let alone near-instant *compilation*!

Because incremental compilation is now usable with both the [self-hosted
ELF linker](release-notes.html#New-ELF-Linker) and the [LLVM
Backend](release-notes.html#LLVM-Backend), opting in is usually as
simple as running `zig build -fincremental --watch`. This command will
spawn a build process which can detect when any source files change and
automatically perform an incremental update.

[Future release cycles](release-notes.html#Roadmap) will continue to
focus on incremental compilation, with more bug fixes, improved testing
infrastructure, performance enhancements, and better
[Linker](release-notes.html#Linker) support.

### [x86 Backend](release-notes.html#toc-x86-Backend) <a href="release-notes.html#x86-Backend" class="hdr">§</a>

- 11 bugs fixed.
- Generates better constant memcpy code
  ([\#25353](https://github.com/ziglang/zig/pull/25353)).

Compared to the [LLVM Backend](release-notes.html#LLVM-Backend), this
backend passes more behavior tests, has significantly faster compilation
speed, superior debug information, and inferior machine code quality. It
remains the default when compiling in Debug mode.

### [aarch64 Backend](release-notes.html#toc-aarch64-Backend) <a href="release-notes.html#aarch64-Backend" class="hdr">§</a>

Still a work-in-progress. Progress was paused during this release cycle
due to the [I/O as an Interface](release-notes.html#IO-as-an-Interface)
churn. Currently crashes when running the behavior tests. Progress is
expected to pick up as the [Standard
Library](release-notes.html#Standard-Library) churn subsides.

### [WebAssembly Backend](release-notes.html#toc-WebAssembly-Backend) <a href="release-notes.html#WebAssembly-Backend" class="hdr">§</a>

Compared to the [LLVM Backend](release-notes.html#LLVM-Backend), Zig's
WebAssembly backend is passing 1813/1970 (92%) of behavior tests.

### [Generating Import Libraries from .def Files Without LLVM](release-notes.html#toc-Generating-Import-Libraries-from-def-Files-Without-LLVM) <a
href="release-notes.html#Generating-Import-Libraries-from-def-Files-Without-LLVM"
class="hdr">§</a>

Eliminates a dependency on LLVM with regards to the set of
[MinGW-w64](release-notes.html#MinGW-w64) .def files shipped with Zig.
This implementation is largely based on the LLVM implementation
(specifically
...
### [Improved Code Generation of For Loop Safety Checks](release-notes.html#toc-Improved-Code-Generation-of-For-Loop-Safety-Checks) <a
href="release-notes.html#Improved-Code-Generation-of-For-Loop-Safety-Checks"
class="hdr">§</a>

Looping over slices generates ~30% less code.

## [Linker](release-notes.html#toc-Linker) <a href="release-notes.html#Linker" class="hdr">§</a>

### [New ELF Linker](release-notes.html#toc-New-ELF-Linker) <a href="release-notes.html#New-ELF-Linker" class="hdr">§</a>

The new linker can be used with `-fnew-linker` in the CLI, or by setting
`exe.use_new_linker = `<span class="tok-null">`true`</span> in a build
script. It is now the default when passing `-fincremental` and targeting
ELF.

Performance data point
\[[source](https://github.com/ziglang/zig/pull/25299#issuecomment-3321207092)\]:
building the Zig [Compiler](release-notes.html#Compiler), then making a
single-line change to a function, and then another:
...
## [Fuzzer](release-notes.html#toc-Fuzzer) <a href="release-notes.html#Fuzzer" class="hdr">§</a>

### [Smith](release-notes.html#toc-Smith) <a href="release-notes.html#Smith" class="hdr">§</a>

<img src="../../img/Carmen_8.svg" style="height: 6em; float: right"
alt="Carmen the Allocgator" />

The
`[]`<span class="tok-kw">`const`</span>` `<span class="tok-type">`u8`</span>
parameter of fuzz tests has been replaced with `*std.testing.Smith`.
This new interface is used to generate values from the fuzzer. It
contains the following base methods:

- `value` for generating any type.
- `eos` for generating end-of-stream markers. Provides the additional
  guarantee that <span class="tok-null">`true`</span> will eventually by
  returned.
...
`[]`<span class="tok-kw">`const`</span>` Smith.Weight`. This is useful
to
...
- `boolWeighted` and `eosSimpleWeighted` for conveniently weighing
  <span class="tok-null">`true`</span> and
...
### [Multiprocess Fuzzing](release-notes.html#toc-Multiprocess-Fuzzing) <a href="release-notes.html#Multiprocess-Fuzzing" class="hdr">§</a>
...
### [Fuzzing Infinite Mode](release-notes.html#toc-Fuzzing-Infinite-Mode) <a href="release-notes.html#Fuzzing-Infinite-Mode" class="hdr">§</a>
...
### [Crash Dumps](release-notes.html#toc-Crash-Dumps) <a href="release-notes.html#Crash-Dumps" class="hdr">§</a>
...
<span class="tok-builtin">`@embedFile`</span>.

### [Numerous bugs found and fixed with the help of an AST smith](release-notes.html#toc-Numerous-bugs-found-and-fixed-with-the-help-of-an-AST-smith) <a
href="release-notes.html#Numerous-bugs-found-and-fixed-with-the-help-of-an-AST-smith"
class="hdr">§</a>
...
<span class="tok-kw">`extern`</span> or
<span class="tok-kw">`inline`</span>; for example,
<span class="tok-kw">`const`</span>` T = `<span class="tok-kw">`struct`</span>` { `<span class="tok-type">`u64`</span>`, `<span class="tok-kw">`extern`</span>` `<span class="tok-kw">`struct`</span>` { a: `<span class="tok-type">`u64`</span>` }, `<span class="tok-type">`u32`</span>` }`
...
## [Bug Fixes](release-notes.html#toc-Bug-Fixes) <a href="release-notes.html#Bug-Fixes" class="hdr">§</a>
...
### [This Release Contains Bugs](release-notes.html#toc-This-Release-Contains-Bugs) <a href="release-notes.html#This-Release-Contains-Bugs"
class="hdr">§</a>
...
## [Toolchain](release-notes.html#toc-Toolchain) <a href="release-notes.html#Toolchain" class="hdr">§</a>

### [LLVM 21](release-notes.html#toc-LLVM-21) <a href="release-notes.html#LLVM-21" class="hdr">§</a>

This release of Zig upgrades to [LLVM
21.1.0](https://releases.llvm.org/21.1.0/docs/ReleaseNotes.html). This
covers Clang ([zig cc](release-notes.html#zig-cc)), libc++, libc++abi,
libunwind, and libtsan as well.

#### [Loop Vectorization Disabled to Work Around Regression](release-notes.html#toc-Loop-Vectorization-Disabled-to-Work-Around-Regression) <a
href="release-notes.html#Loop-Vectorization-Disabled-to-Work-Around-Regression"
class="hdr">§</a>
...
### [musl 1.2.5](release-notes.html#toc-musl-125) <a href="release-notes.html#musl-125" class="hdr">§</a>
...
libc](release-notes.html#zig-libc) rather than source files copied from
musl. Specifically, 331 fewer musl C source files are now distributed
with Zig, with 1,206 remaining. Therefore, if you encounter bugs with
musl libc provided by Zig, please respect upstream by reporting them to
...
### [glibc 2.43](release-notes.html#toc-glibc-243) <a href="release-notes.html#glibc-243" class="hdr">§</a>

glibc version 2.43 is now available when cross-compiling.

### [Linux 6.19 Headers](release-notes.html#toc-Linux-619-Headers) <a href="release-notes.html#Linux-619-Headers" class="hdr">§</a>

This release includes Linux kernel headers for version 6.19.

### [macOS 26.4 Headers](release-notes.html#toc-macOS-264-Headers) <a href="release-notes.html#macOS-264-Headers" class="hdr">§</a>

This release includes macOS system headers for version 26.4.

### [MinGW-w64](release-notes.html#toc-MinGW-w64) <a href="release-notes.html#MinGW-w64" class="hdr">§</a>

Zig 0.16.0 continues to distribute MinGW-w64 commit
`38c8142f660b6ba11e7c408f2de1e9f8bfaf839e`.

However, many functions are now provided by [zig
libc](release-notes.html#zig-libc) rather than source files copied from
MinGW-w64. Specifically, 99 fewer MinGW-w64 C source files are now
distributed with Zig, with 398 remaining. Therefore, if you encounter
bugs with MinGW-w64 libc provided by Zig, please respect upstream by
reporting them to Zig's issue tracker rather than MinGW-w64's.

### [FreeBSD 15.0 libc](release-notes.html#toc-FreeBSD-150-libc) <a href="release-notes.html#FreeBSD-150-libc" class="hdr">§</a>

FreeBSD libc version 15.0 is now available when cross-compiling.

### [WASI libc](release-notes.html#toc-WASI-libc) <a href="release-notes.html#WASI-libc" class="hdr">§</a>
...
with [musl](release-notes.html#musl-125).

### [zig libc](release-notes.html#toc-zig-libc) <a href="release-notes.html#zig-libc" class="hdr">§</a>

Zig's libc implementation gained many new functions, leading to the
corresponding C source files being deleted from
[musl](release-notes.html#musl-125) and
[MinGW-w64](release-notes.html#MinGW-w64). In this release, the number
of C source files distributed went from 2,270 to 1,873 (-17%).
...
### [zig cc](release-notes.html#toc-zig-cc) <a href="release-notes.html#zig-cc" class="hdr">§</a>
...
### [Support dynamically-linked OpenBSD libc when cross-compiling](release-notes.html#toc-Support-dynamically-linked-OpenBSD-libc-when-cross-compiling) <a
href="release-notes.html#Support-dynamically-linked-OpenBSD-libc-when-cross-compiling"
class="hdr">§</a>
...
## [Roadmap](release-notes.html#toc-Roadmap) <a href="release-notes.html#Roadmap" class="hdr">§</a>
...
- Completing the [aarch64 Backend](release-notes.html#aarch64-Backend),
  making it the default backend for debug mode.
- Enhancing [Linker](release-notes.html#Linker) implementations,
  eliminating dependency on [LLD](https://lld.llvm.org/) and supporting
  [Incremental Compilation](release-notes.html#Incremental-Compilation).
- Enhancing the integrated [Fuzzer](release-notes.html#Fuzzer) to be
  competitive with AFL and other state-of-the-art fuzzers.
...
## [Thank You Contributors!](release-notes.html#toc-Thank-You-Contributors) <a href="release-notes.html#Thank-You-Contributors" class="hdr">§</a>

<img src="../../img/Ziggy_7.svg" style="height: 11em; float: right"
alt="Ziggy the Ziguana" />
...
## [Thank You Sponsors!](release-notes.html#toc-Thank-You-Sponsors) <a href="release-notes.html#Thank-You-Sponsors" class="hdr">§</a>

<img src="../../img/Ziggy_6.svg" style="height: 11em"
alt="Ziggy the Ziguana" />

Special thanks to those who [sponsor Zig](https://ziglang.org/zsf/).
Because of diverse, recurring donations, Zig is driven by the open
source community, rather than the goal of making profit. In particular,
those below sponsor Zig for \$50/month or more using our [preferred
donation platform](https://www.every.org/zig-software-foundation-inc):
