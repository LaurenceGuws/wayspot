...
|  |  |  |
|----|----|----|
| [TTF_TextEngine](TTF_TextEngine.html) \* | **engine** | the text engine to use when creating the text object, may be NULL. |
...
([TTF_Text](TTF_Text.html) \*) Returns a [TTF_Text](TTF_Text.html)
object or NULL on failure; call SDL_GetError() for more information.

## Thread Safety

This function should be called on the thread that created the font and
text engine.
