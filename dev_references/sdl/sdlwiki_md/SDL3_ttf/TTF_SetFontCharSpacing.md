...
|  |  |  |
|----|----|----|
| [TTF_Font](TTF_Font.html) \* | **font** | the font to specify a direction for. |
...
The spacing value is applied uniformly after each character, in addition
to the normal glyph's advance.
