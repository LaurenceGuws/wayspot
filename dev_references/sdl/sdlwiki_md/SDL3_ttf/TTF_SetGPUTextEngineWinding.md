...
|  |  |  |
|----|----|----|
| [TTF_TextEngine](TTF_TextEngine.html) \* | **engine** | a [TTF_TextEngine](TTF_TextEngine.html) object created with [TTF_CreateGPUTextEngine](TTF_CreateGPUTextEngine.html)(). |
| [TTF_GPUTextEngineWinding](TTF_GPUTextEngineWinding.html) | **winding** | the new winding order option. |
