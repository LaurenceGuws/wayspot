...
|  |  |  |
|----|----|----|
| [TTF_Font](TTF_Font.html) \* | **font** | the font to set SDF support on. |
...
This works with Blended APIs, and generates the raw signed distance
values in the alpha channel of the resulting texture.
