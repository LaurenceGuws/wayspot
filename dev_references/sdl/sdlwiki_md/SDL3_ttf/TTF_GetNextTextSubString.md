...
| [TTF_SubString](TTF_SubString.html) \* | **next** | a pointer filled in with the next substring. |
...
substring with the [TTF_SUBSTRING_TEXT_END](TTF_SUBSTRING_TEXT_END.html)
flag set.
