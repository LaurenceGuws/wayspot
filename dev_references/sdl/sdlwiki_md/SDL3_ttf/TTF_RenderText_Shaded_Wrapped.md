...
(SDL_Surface \*) Returns a new 8-bit, palettized surface, or NULL if
there was an error.
...
pixels have varying degrees of the foreground color. This function
...
and [TTF_RenderText_LCD_Wrapped](TTF_RenderText_LCD_Wrapped.html).
