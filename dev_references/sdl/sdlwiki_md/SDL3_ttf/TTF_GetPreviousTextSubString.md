...
| const [TTF_SubString](TTF_SubString.html) \* | **substring** | the [TTF_SubString](TTF_SubString.html) to query. |
| [TTF_SubString](TTF_SubString.html) \* | **previous** | a pointer filled in with the previous substring in the text object. |
...
substring with the
[TTF_SUBSTRING_TEXT_START](TTF_SUBSTRING_TEXT_START.html) flag set.
