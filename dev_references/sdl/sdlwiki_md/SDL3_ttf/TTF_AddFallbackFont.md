...
| [TTF_Font](TTF_Font.html) \* | **fallback** | the font to add as a fallback. |
...
Add a font that will be used for glyphs that are not in the current
font. The fallback font should have the same size and style as the
current font.
