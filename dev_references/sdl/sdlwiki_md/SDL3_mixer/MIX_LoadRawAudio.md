...
RAM, allocating a copy. If the original data will outlive the created
[MIX_Audio](MIX_Audio.html), you can use
[MIX_LoadRawAudioNoCopy](MIX_LoadRawAudioNoCopy.html)() to avoid extra
