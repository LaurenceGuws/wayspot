...
(Sint64) Returns the track's current sample frame position, or -1 on
error; call SDL_GetError() for details.

## Remarks

(Not to be confused with
[MIX_GetTrack3DPosition](MIX_GetTrack3DPosition.html)(), which is
...
in units of time, use [MIX_TrackFramesToMS](MIX_TrackFramesToMS.html)()
to convert the return value to milliseconds.
