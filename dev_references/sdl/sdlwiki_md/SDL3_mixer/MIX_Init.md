...
SDL_mixer function can be used.

It is safe to call this multiple times; the library will only initialize
once, and won't deinitialize until [MIX_Quit](MIX_Quit.html)() has been
called a matching number of times. Extra attempts to init report
success.
