...
Decode more audio from a [MIX_AudioDecoder](MIX_AudioDecoder.html).
...
|  |  |  |
|----|----|----|
| [MIX_AudioDecoder](MIX_AudioDecoder.html) \* | **audiodecoder** | the decoder from which to retrieve more data. |
...
(int) Returns number of bytes decoded, or -1 on error; call
...
than requested if there was an error or end-of-file. A return value of
zero means the entire file was decoded, -1 means an unrecoverable error
happened.
