...
|  |  |  |
|----|----|----|
| [MIX_Track](MIX_Track.html) \* | **track** | the track on which to query the frequency ratio. |
...
track's audio. A value greater than 1.0f will play the audio faster, and
at a higher pitch. A value less than 1.0f will play the audio slower,
and at a lower pitch. 1.0f is normal speed.

The default value is 1.0f.

On various errors ([MIX_Init](MIX_Init.html)() was not called, the track
is NULL), this returns 0.0f. Since this is not a valid value to set,
this can be seen as an error state.
