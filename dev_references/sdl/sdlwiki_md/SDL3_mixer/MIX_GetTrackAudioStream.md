...
(SDL_AudioStream \*) Returns an SDL_AudioStream if available, NULL if
not.
...
through a call to
[MIX_SetTrackAudioStream](MIX_SetTrackAudioStream.html)(). If there is
none assigned, or the track has an input that isn't an SDL_AudioStream
(such as a [MIX_Audio](MIX_Audio.html) or SDL_IOStream), this will
return NULL.
