...
| const [SDL_FRect](SDL_FRect.html) \* | **srcrect** | the [SDL_Rect](SDL_Rect.html) structure representing the rectangle to be used for the 9-grid, or NULL to use the entire texture. |
