...
Function interface for [SDL_Storage](SDL_Storage.html).
...
[SDL_Storage](SDL_Storage.html) will fill in all the functions in this
struct, and then pass it to [SDL_OpenStorage](SDL_OpenStorage.html) to
create a custom [SDL_Storage](SDL_Storage.html) object.
