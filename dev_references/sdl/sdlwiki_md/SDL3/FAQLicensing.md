...
As of SDL 2.0, the software is freely available under the terms of the
zlib license.
...
SDL can be freely used in commercial applications either as a static
library or as a shared library (recommended!)
...
Yes, code from the test directory and from the examples in the
documentation is placed in the public domain. Anyone can use it for any
purpose.
