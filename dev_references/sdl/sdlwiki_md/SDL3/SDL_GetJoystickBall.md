...
|  |  |  |
|----|----|----|
| [SDL_Joystick](SDL_Joystick.html) \* | **joystick** | the [SDL_Joystick](SDL_Joystick.html) to query. |
...
[SDL_GetJoystickBall](SDL_GetJoystickBall.html)(), these motion deltas
are placed into `dx` and `dy`.
