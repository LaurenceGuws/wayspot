...
|  |  |  |
|----|----|----|
| [SDL_GLAttr](SDL_GLAttr.html) | **attr** | an enum value specifying the OpenGL attribute to set. |
...
attributes should be set before creating an OpenGL window. You should
use [SDL_GL_GetAttribute](SDL_GL_GetAttribute.html)() to check the
