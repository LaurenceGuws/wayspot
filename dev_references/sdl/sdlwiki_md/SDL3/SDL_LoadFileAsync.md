...
[SDL_AsyncIOOutcome](SDL_AsyncIOOutcome.html)'s bytes_transferred value.

This function will allocate the buffer to contain the file. It must be
deallocated by calling [SDL_free](SDL_free.html)() on
[SDL_AsyncIOOutcome](SDL_AsyncIOOutcome.html)'s buffer field after
completion.
