...
|                                    |             |                       |
|------------------------------------|-------------|-----------------------|
| [SDL_Process](SDL_Process.html) \* | **process** | the process to query. |
...
- [`SDL_PROP_PROCESS_PID_NUMBER`](SDL_PROP_PROCESS_PID_NUMBER.html): the
  process ID of the process.
- [`SDL_PROP_PROCESS_STDIN_POINTER`](SDL_PROP_PROCESS_STDIN_POINTER.html):
  an [SDL_IOStream](SDL_IOStream.html) that can be used to write input
...
- [`SDL_PROP_PROCESS_STDOUT_POINTER`](SDL_PROP_PROCESS_STDOUT_POINTER.html):
  a non-blocking [SDL_IOStream](SDL_IOStream.html) that can be used to
