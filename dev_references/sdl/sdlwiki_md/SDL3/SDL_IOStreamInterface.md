...
The function pointers that drive an [SDL_IOStream](SDL_IOStream.html).
...
Applications can provide this struct to [SDL_OpenIO](SDL_OpenIO.html)()
to create their own implementation of [SDL_IOStream](SDL_IOStream.html).
This is not necessarily required, as SDL already offers several common
types of I/O streams, via functions like
[SDL_IOFromFile](SDL_IOFromFile.html)() and
