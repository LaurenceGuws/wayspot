...
window size may not have have been applied immediately upon the return
...
not match the exact size requested, as some windowing systems can
restrict the window size in certain scenarios (e.g. constraining the
