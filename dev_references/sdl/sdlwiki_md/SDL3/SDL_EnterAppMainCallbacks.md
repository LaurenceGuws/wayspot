...
| [SDL_AppInit_func](SDL_AppInit_func.html) | **appinit** | the application's [SDL_AppInit](SDL_AppInit.html) function. |
| [SDL_AppIterate_func](SDL_AppIterate_func.html) | **appiter** | the application's [SDL_AppIterate](SDL_AppIterate.html) function. |
| [SDL_AppEvent_func](SDL_AppEvent_func.html) | **appevent** | the application's [SDL_AppEvent](SDL_AppEvent.html) function. |
| [SDL_AppQuit_func](SDL_AppQuit_func.html) | **appquit** | the application's [SDL_AppQuit](SDL_AppQuit.html) function. |
...
[SDL_main](SDL_main.html).h as small as possible.
