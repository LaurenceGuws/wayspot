...
| [SDL_Rect](SDL_Rect.html) \* | **rect** | the [SDL_Rect](SDL_Rect.html) structure filled in with the display bounds. |
...
[SDL_GetDisplayBounds](SDL_GetDisplayBounds.html)() reports, but with
...
areas, so these are good guidelines for the maximum space available to a
