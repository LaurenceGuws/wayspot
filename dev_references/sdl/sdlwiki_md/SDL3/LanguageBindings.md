# SDL3 Language Bindings

(SDL2 language bindings are listed
[here](../SDL2/LanguageBindings.html).)

The Simple DirectMedia Layer library has bindings to many different
programming languages. While SDL is written in C, it works well with C++
and many people like to use it with various scripting languages and
