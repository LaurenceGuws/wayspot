...
| [SDL_PixelFormat](SDL_PixelFormat.html) | **format** | one of the enumerated values in [SDL_PixelFormat](SDL_PixelFormat.html). |
| [SDL_TextureAccess](SDL_TextureAccess.html) | **access** | one of the enumerated values in [SDL_TextureAccess](SDL_TextureAccess.html). |
