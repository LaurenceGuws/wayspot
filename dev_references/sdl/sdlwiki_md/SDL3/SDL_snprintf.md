...
(int) Returns the number of bytes that should be written, not counting
...
This function returns the number of *bytes* (not *characters*) that
should be written, excluding the null-terminator character. If this
returns a number \>= `maxlen`, it means the output string was truncated.
