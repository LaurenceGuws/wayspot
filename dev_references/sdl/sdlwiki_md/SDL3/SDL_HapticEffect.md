...
You can also pass [SDL_HAPTIC_INFINITY](SDL_HAPTIC_INFINITY.html) to
length instead of a 0-32767 value. Neither delay, interval,
attack_length nor fade_length support
[SDL_HAPTIC_INFINITY](SDL_HAPTIC_INFINITY.html). Fade will also not be
used since effect never ends.

Additionally, the [SDL_HAPTIC_RAMP](SDL_HAPTIC_RAMP.html) effect does
not support a duration of
