...
|                               |            |                             |
|-------------------------------|------------|-----------------------------|
| [SDL_Folder](SDL_Folder.html) | **folder** | the type of folder to find. |
...
storing pictures, music or videos for a certain user. This function
gives the path for many of those special locations.

This function is specifically for *user* folders, which are meant for
the user to access and manage. For application-specific folders, meant
to hold data for the application to manage, see
[SDL_GetBasePath](SDL_GetBasePath.html)() and
