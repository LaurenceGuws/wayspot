...
The definition of `z = atan2(x, y)` is `y = x tan(z)`, where the
quadrant of z is determined based on the signs of x and y.
...
[SDL_atan2](SDL_atan2.html) for double-precision floats.
