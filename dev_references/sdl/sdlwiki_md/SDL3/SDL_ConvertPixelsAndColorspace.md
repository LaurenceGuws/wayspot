...
| [SDL_PixelFormat](SDL_PixelFormat.html) | **src_format** | an [SDL_PixelFormat](SDL_PixelFormat.html) value of the `src` pixels format. |
| [SDL_Colorspace](SDL_Colorspace.html) | **src_colorspace** | an [SDL_Colorspace](SDL_Colorspace.html) value describing the colorspace of the `src` pixels. |
| [SDL_PropertiesID](SDL_PropertiesID.html) | **src_properties** | an [SDL_PropertiesID](SDL_PropertiesID.html) with additional source color properties, or 0. |
| const void \* | **src** | a pointer to the source pixels. |
| int | **src_pitch** | the pitch of the source pixels, in bytes. |
| [SDL_PixelFormat](SDL_PixelFormat.html) | **dst_format** | an [SDL_PixelFormat](SDL_PixelFormat.html) value of the `dst` pixels format. |
| [SDL_Colorspace](SDL_Colorspace.html) | **dst_colorspace** | an [SDL_Colorspace](SDL_Colorspace.html) value describing the colorspace of the `dst` pixels. |
| [SDL_PropertiesID](SDL_PropertiesID.html) | **dst_properties** | an [SDL_PropertiesID](SDL_PropertiesID.html) with additional destination color properties, or 0. |
