...
Returns a newly-allocated array of attributes, terminated with
`EGL_NONE`.
...
The callback should return a pointer to an EGL attribute array
terminated with `EGL_NONE`. If this function returns NULL, the
[SDL_CreateWindow](SDL_CreateWindow.html) process will fail gracefully.
