...
|  |  |  |
|----|----|----|
| const [SDL_MessageBoxData](SDL_MessageBoxData.html) \* | **messageboxdata** | the [SDL_MessageBoxData](SDL_MessageBoxData.html) structure with title, text and other options. |
