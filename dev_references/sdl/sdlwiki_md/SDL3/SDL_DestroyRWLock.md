...
Destroy a read/write lock created with
...
|                                  |            |                        |
|----------------------------------|------------|------------------------|
| [SDL_RWLock](SDL_RWLock.html) \* | **rwlock** | the rwlock to destroy. |
...
it is not safe to attempt to destroy a locked rwlock, and may result in
