...
|  |  |  |
|----|----|----|
| [SDL_Joystick](SDL_Joystick.html) \* | **joystick** | the joystick to update. |
...
For joysticks with a single color LED, the maximum of the RGB values
will be used as the LED brightness.
