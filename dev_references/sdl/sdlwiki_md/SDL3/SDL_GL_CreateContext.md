...
([SDL_GLContext](SDL_GLContext.html)) Returns the OpenGL context
associated with `window` or NULL on failure; call
...
The [SDL_Window](SDL_Window.html) specified must have been created with
the [SDL_WINDOW_OPENGL](SDL_WINDOW_OPENGL.html) flag, or context
creation will fail.
...
[SDL_GL_GetProcAddress](SDL_GL_GetProcAddress.html)() and its related
functions.

[SDL_GLContext](SDL_GLContext.html) is opaque to the application.
