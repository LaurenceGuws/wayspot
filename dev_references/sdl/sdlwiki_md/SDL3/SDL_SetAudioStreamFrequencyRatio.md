...
|  |  |  |
|----|----|----|
| [SDL_AudioStream](SDL_AudioStream.html) \* | **stream** | the stream on which the frequency ratio is being changed. |
...
higher pitch. A value less than 1.0f will play the audio slower, and at
a lower pitch. 1.0f means play at normal speed.

This is applied during
[SDL_GetAudioStreamData](SDL_GetAudioStreamData.html), and can be
continuously changed to create various effects.
