...
[SDL_APP_CONTINUE](SDL_APP_CONTINUE.html). The function should operate
as a single iteration the program's primary loop; it should update
...
SDL will send events as they arrive in
[SDL_AppEvent](SDL_AppEvent.html), and in most cases the event queue
will be empty when this function runs anyhow.
...
[SDL_AppEvent](SDL_AppEvent.html)() for events not pushed on the main
thread.
