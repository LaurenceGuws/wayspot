...
|  |  |  |
|----|----|----|
| [SDL_Surface](SDL_Surface.html) \* | **surface** | an [SDL_Surface](SDL_Surface.html) structure representing the cursor image. |
...
is enabled. For example, if the original surface is 32x32, then on a 2x
