...
[SDL_EVENT_AUDIO_DEVICE_ADDED](SDL_EVENT_AUDIO_DEVICE_ADDED.html) event
for every device it discovers during initialization. After that, this
event will only arrive when a device is hotplugged during the program's
run.
