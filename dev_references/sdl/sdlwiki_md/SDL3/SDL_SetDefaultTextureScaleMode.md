...
|  |  |  |
|----|----|----|
| [SDL_Renderer](SDL_Renderer.html) \* | **renderer** | the renderer to update. |
| [SDL_ScaleMode](SDL_ScaleMode.html) | **scale_mode** | the scale mode to change to for new textures. |
