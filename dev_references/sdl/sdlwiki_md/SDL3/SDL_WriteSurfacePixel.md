...
|  |  |  |
|----|----|----|
| [SDL_Surface](SDL_Surface.html) \* | **surface** | the surface to write. |
...
Like [SDL_MapRGBA](SDL_MapRGBA.html), this uses the entire 0..255 range
when converting color components from pixel formats with less than 8
