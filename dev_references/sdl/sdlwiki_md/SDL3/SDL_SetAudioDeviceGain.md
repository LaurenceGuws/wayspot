...
|  |  |  |
|----|----|----|
| [SDL_AudioDeviceID](SDL_AudioDeviceID.html) | **devid** | the audio device on which to change gain. |
...
and this function will always return false when used on physical
devices. While it might seem attractive to adjust several logical
devices at once in this way, it would allow an app or library to
interfere with another portion of the program's otherwise-isolated
devices.
