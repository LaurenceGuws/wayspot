...
the page size on this platform. It will *not* set an error string to be
retrieved with [SDL_GetError](SDL_GetError.html)() in this case! In this
case, defaulting to 4096 is often a reasonable option.
