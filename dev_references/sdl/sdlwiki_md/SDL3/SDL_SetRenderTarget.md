...
| [SDL_Texture](SDL_Texture.html) \* | **texture** | the targeted texture, which must be created with the [`SDL_TEXTUREACCESS_TARGET`](SDL_TEXTUREACCESS_TARGET.html) flag, or NULL to render to the window instead of a texture. |
