...
|                       |       |                         |
|-----------------------|-------|-------------------------|
| [Uint32](Uint32.html) | **x** | the value to byte-swap. |

## Return Value

([Uint32](Uint32.html)) Returns `x`, with its bytes in the opposite
endian order.
...
[SDL_Swap32LE](SDL_Swap32LE.html) or [SDL_Swap32BE](SDL_Swap32BE.html)
