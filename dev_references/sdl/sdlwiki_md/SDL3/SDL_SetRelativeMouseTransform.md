...
|  |  |  |
|----|----|----|
| [SDL_MouseMotionTransformCallback](SDL_MouseMotionTransformCallback.html) | **callback** | a callback used to transform relative mouse motion, or NULL for default behavior. |
