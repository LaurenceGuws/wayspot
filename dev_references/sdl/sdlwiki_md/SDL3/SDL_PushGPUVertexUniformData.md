...
| [Uint32](Uint32.html) | **slot_index** | the vertex uniform slot to push data to. |
...
For detailed information about accessing uniform data from a shader,
please refer to [SDL_CreateGPUShader](SDL_CreateGPUShader.html).
