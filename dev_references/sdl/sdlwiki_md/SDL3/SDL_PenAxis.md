...
[SDL_PenAxisEvent](SDL_PenAxisEvent.html). All axes are either
normalised to 0..1 or report a (positive or negative) angle in degrees,
with 0.0 representing the centre. Not all pens/backends support all
axes: unsupported axes are always zero.

To convert angles for tilt and rotation into vector representation, use
[SDL_sinf](SDL_sinf.html) on the XTILT, YTILT, or ROTATION component,
for example:
...
[CategoryAPIEnum](CategoryAPIEnum.html), [CategoryPen](CategoryPen.html)
