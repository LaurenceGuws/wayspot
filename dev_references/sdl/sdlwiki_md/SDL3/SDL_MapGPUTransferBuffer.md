...
| [SDL_GPUTransferBuffer](SDL_GPUTransferBuffer.html) \* | **transfer_buffer** | a transfer buffer. |
| bool | **cycle** | if true, cycles the transfer buffer if it is already bound. |

## Return Value

(void \*) Returns the address of the mapped transfer buffer memory, or
...
memory is owned by the graphics driver - do NOT call
[SDL_free](SDL_free.html)() on the returned pointer.
