...
|  |  |  |
|----|----|----|
| [SDL_Renderer](SDL_Renderer.html) \* | **renderer** | the renderer which should draw multiple rectangles. |
| const [SDL_FRect](SDL_FRect.html) \* | **rects** | a pointer to an array of destination rectangles. |
