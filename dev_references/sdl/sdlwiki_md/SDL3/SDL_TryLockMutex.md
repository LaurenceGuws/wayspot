...
|                                |           |                           |
|--------------------------------|-----------|---------------------------|
| [SDL_Mutex](SDL_Mutex.html) \* | **mutex** | the mutex to try to lock. |
...
This works just like [SDL_LockMutex](SDL_LockMutex.html)(), but if the
mutex is not available, this function returns false immediately.
