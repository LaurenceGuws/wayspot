...
Override for [SDL_GetPreferredLocales](SDL_GetPreferredLocales.html)().
...
generate a [SDL_EVENT_LOCALE_CHANGED](SDL_EVENT_LOCALE_CHANGED.html)
event (but if you can change the hint, you can push your own event, if
you want).
