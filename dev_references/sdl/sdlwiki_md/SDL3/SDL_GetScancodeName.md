...
e.g. the name for [`SDL_SCANCODE_LGUI`](SDL_SCANCODE_LGUI.html) is "Left
GUI" under Linux but "Left Windows" under Microsoft Windows, and some
scancodes like
[`SDL_SCANCODE_NONUSBACKSLASH`](SDL_SCANCODE_NONUSBACKSLASH.html) don't
have any name at all. There are even scancodes that share names, e.g.
[`SDL_SCANCODE_RETURN`](SDL_SCANCODE_RETURN.html) and
[`SDL_SCANCODE_RETURN2`](SDL_SCANCODE_RETURN2.html) (both called
"Return"). This function is therefore unsuitable for creating a stable
