...
| [SDL_RendererLogicalPresentation](SDL_RendererLogicalPresentation.html) \* | **mode** | a variable filled with the logical presentation mode being used. |
...
or 0 if a logical resolution is not enabled.
