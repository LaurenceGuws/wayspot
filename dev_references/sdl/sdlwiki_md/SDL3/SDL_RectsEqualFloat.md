...
|                                      |       |                               |
|--------------------------------------|-------|-------------------------------|
| const [SDL_FRect](SDL_FRect.html) \* | **a** | the first rectangle to test.  |
| const [SDL_FRect](SDL_FRect.html) \* | **b** | the second rectangle to test. |
...
x, y, width and height are within
[SDL_FLT_EPSILON](SDL_FLT_EPSILON.html) of each other. This is often a
reasonable way to compare two floating point rectangles and deal with
the slight precision variations in floating point calculations that tend
to pop up.
