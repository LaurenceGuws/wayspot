...
Draws data using bound graphics state and with draw parameters set from
a buffer.
...
match the layout of
[SDL_GPUIndirectDrawCommand](SDL_GPUIndirectDrawCommand.html). You must
not call this function before binding a graphics pipeline.
