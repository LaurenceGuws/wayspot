...
(bool) Returns true if devid is a physical device, false if it is
logical.

## Remarks

An [SDL_AudioDeviceID](SDL_AudioDeviceID.html) that represents physical
hardware is a physical device; there is one for each piece of hardware
that SDL can see. Logical devices are created by calling
[SDL_OpenAudioDevice](SDL_OpenAudioDevice.html) or
[SDL_OpenAudioDeviceStream](SDL_OpenAudioDeviceStream.html), and while
...
if an arbitrary device ID is physical or logical. This function reports
which.
