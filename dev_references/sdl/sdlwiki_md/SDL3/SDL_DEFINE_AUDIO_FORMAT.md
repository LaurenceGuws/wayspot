...
Define an [SDL_AudioFormat](SDL_AudioFormat.html) value.
...
use externally, but it can be illustrative as to what the various bits
of an [SDL_AudioFormat](SDL_AudioFormat.html) mean.

For example, [SDL_AUDIO_S32LE](SDL_AUDIO_S32LE.html) looks like this:
