...
The definition of `y = exp(x)` is `y = e^x`, where `e` is the base of
the natural logarithm. The inverse is the natural logarithm,
...
[SDL_expf](SDL_expf.html) for single-precision floats.
