...
| [Uint32](Uint32.html) | **first_slot** | the compute sampler slot to begin binding from. |
...
| [Uint32](Uint32.html) | **num_bindings** | the number of texture-sampler bindings to bind from the array. |
