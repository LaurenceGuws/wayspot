...
|  |  |  |
|----|----|----|
| [SDL_Window](SDL_Window.html) \* | **window** | the window that should become the child of a parent. |
| [SDL_Window](SDL_Window.html) \* | **parent** | the new parent window for the child window. |
...
state will fail. Use [SDL_SetWindowModal](SDL_SetWindowModal.html)() to
cancel the modal status before attempting to change the parent.

Popup windows cannot change parents and attempts to do so will fail.

Setting a parent window that is currently the sibling or descendent of
the child window results in undefined behavior.
