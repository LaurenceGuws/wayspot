...
Wait until a condition variable is signaled or a certain time has
passed.
...
|  |  |  |
|----|----|----|
| [SDL_Condition](SDL_Condition.html) \* | **cond** | the condition variable to wait on. |
| [SDL_Mutex](SDL_Mutex.html) \* | **mutex** | the mutex used to coordinate thread access. |
...
to call [SDL_SignalCondition](SDL_SignalCondition.html)() or
[SDL_BroadcastCondition](SDL_BroadcastCondition.html)() on the condition
