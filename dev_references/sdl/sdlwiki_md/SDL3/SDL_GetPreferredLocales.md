...
Defined in
[\<SDL3/SDL_locale.h\>](https://github.com/libsdl-org/SDL/blob/main/include/SDL3/SDL_locale.h)
...
([SDL_Locale](SDL_Locale.html) \*\*) Returns a NULL terminated array of
locale pointers, or NULL on failure; call
...
enough Japanese to navigate around Tokyo might have a list like: { "de",
"en_US", "jp", NULL }. Someone from England might prefer British English
(where "color" is spelled "colour", etc), but will settle for anything
like it: { "en_GB", "en", NULL }.
...
of your program; SDL will send an
[SDL_EVENT_LOCALE_CHANGED](SDL_EVENT_LOCALE_CHANGED.html) event in this
case, if possible, and you can call this function again to get an
