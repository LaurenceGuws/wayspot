...
(const char \*) Returns the current value of the metadata property, or
the default if it is not set, NULL for properties with no default.

## Remarks

This returns metadata previously set using
[SDL_SetAppMetadata](SDL_SetAppMetadata.html)() or
[SDL_SetAppMetadataProperty](SDL_SetAppMetadataProperty.html)(). See
[SDL_SetAppMetadataProperty](SDL_SetAppMetadataProperty.html)() for the
list of available properties and their meanings.
...
[SDL_SetAppMetadataProperty](SDL_SetAppMetadataProperty.html)() to set
that property from another thread.
