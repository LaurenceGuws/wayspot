...
|  |  |  |
|----|----|----|
| [SDL_AudioStream](SDL_AudioStream.html) \* | **stream** | the stream the format is being changed. |
| const [SDL_AudioSpec](SDL_AudioSpec.html) \* | **src_spec** | the new format of the audio input; if NULL, it is not changed. |
| const [SDL_AudioSpec](SDL_AudioSpec.html) \* | **dst_spec** | the new format of the audio output; if NULL, it is not changed. |
...
[SDL_GetAudioStreamData](SDL_GetAudioStreamData.html) will reflect the
new format, and future calls to
[SDL_PutAudioStreamData](SDL_PutAudioStreamData.html) must provide data
in the new input formats.
