...
map by default to [SDLK_0](SDLK_0.html)...[SDLK_9](SDLK_9.html) on
AZERTY layouts.

Keys with the [`SDLK_EXTENDED_MASK`](SDLK_EXTENDED_MASK.html) bit set do
not map to a scancode or Unicode code point.
