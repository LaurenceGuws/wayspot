...
- [`SDL_PROP_DISPLAY_HDR_ENABLED_BOOLEAN`](SDL_PROP_DISPLAY_HDR_ENABLED_BOOLEAN.html):
  ...
  is for informational and diagnostic purposes only, as not all
...
- [`SDL_PROP_DISPLAY_KMSDRM_PANEL_ORIENTATION_NUMBER`](SDL_PROP_DISPLAY_KMSDRM_PANEL_ORIENTATION_NUMBER.html):
  ...
  clockwise rotation. Note that this is provided only as a hint, and the
  application is responsible for any coordinate transformations needed
  to conform to the requested display orientation.
