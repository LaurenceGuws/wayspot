...
[SDL_SubmitGPUCommandBuffer](SDL_SubmitGPUCommandBuffer.html) is called.
...
buffer A and then command buffer B all commands in A will begin
executing before any command in B begins executing.
