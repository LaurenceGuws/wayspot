...
(bool) Returns the value of the property, or `default_value` if it is
not set or not a boolean property.

## Remarks

You can use [SDL_GetPropertyType](SDL_GetPropertyType.html)() to query
whether the property exists and is a boolean property.
