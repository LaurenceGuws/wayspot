...
|                                    |          |                    |
|------------------------------------|----------|--------------------|
| const [SDL_Rect](SDL_Rect.html) \* | **rect** | the rect to query. |

## Return Value

([SDL_DisplayID](SDL_DisplayID.html)) Returns the instance ID of the
display entirely containing the rect or closest to the center of the
rect on success or 0 on failure; call
