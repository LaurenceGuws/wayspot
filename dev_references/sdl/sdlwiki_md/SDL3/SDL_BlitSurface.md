...
| const [SDL_Rect](SDL_Rect.html) \* | **dstrect** | the [SDL_Rect](SDL_Rect.html) structure representing the x and y position in the destination surface, or NULL for (0,0). The width and height are ignored, and are copied from `srcrect`. If you want a specific width and height, you should use [SDL_BlitSurfaceScaled](SDL_BlitSurfaceScaled.html)(). |
