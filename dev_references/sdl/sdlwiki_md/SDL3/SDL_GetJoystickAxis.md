...
([Sint16](Sint16.html)) Returns a 16-bit signed integer representing the
current position of the axis or 0 on failure; call
...
this lower-level interface, so you know that a specific axis is the
"left thumb stick," etc.

The value returned by [SDL_GetJoystickAxis](SDL_GetJoystickAxis.html)()
