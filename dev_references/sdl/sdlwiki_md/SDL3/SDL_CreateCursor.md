...
([SDL_Cursor](SDL_Cursor.html) \*) Returns a new cursor with the
specified parameters on success or NULL on failure; call
...
[SDL_Surface](SDL_Surface.html), you should use
[SDL_CreateColorCursor](SDL_CreateColorCursor.html)(). Alternately, you
can hide the cursor and draw your own as part of your game's rendering,
but it will be bound to the framerate.

Also, [SDL_CreateSystemCursor](SDL_CreateSystemCursor.html)() is
available, which provides several readily-available system cursors to
pick from.
