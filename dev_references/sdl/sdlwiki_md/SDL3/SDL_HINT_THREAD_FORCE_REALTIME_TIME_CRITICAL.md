...
to restrictions that require special handling by the application. This
hint exists to let SDL know that the app is prepared to handle said
restrictions.
...
- An RLIMIT_RTTIME budget will be configured to the rtkit specified
  limit.
