...
| [Uint32](Uint32.html) | **first_slot** | the vertex storage texture slot to begin binding from. |
| [SDL_GPUTexture](SDL_GPUTexture.html) \*const \* | **storage_textures** | an array of storage textures. |
| [Uint32](Uint32.html) | **num_bindings** | the number of storage texture to bind from the array. |
