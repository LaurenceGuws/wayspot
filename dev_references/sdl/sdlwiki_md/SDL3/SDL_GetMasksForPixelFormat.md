...
Convert one of the enumerated pixel formats to a bpp value and RGBA
masks.
...
| [Uint32](Uint32.html) \* | **Rmask** | a pointer filled in with the red mask for the format. |
| [Uint32](Uint32.html) \* | **Gmask** | a pointer filled in with the green mask for the format. |
| [Uint32](Uint32.html) \* | **Bmask** | a pointer filled in with the blue mask for the format. |
| [Uint32](Uint32.html) \* | **Amask** | a pointer filled in with the alpha mask for the format. |
