...
Defined in
[\<SDL3/SDL_bits.h\>](https://github.com/libsdl-org/SDL/blob/main/include/SDL3/SDL_bits.h)
...
|                       |       |                              |
|-----------------------|-------|------------------------------|
| [Uint32](Uint32.html) | **x** | the 32-bit value to examine. |

## Return Value

(int) Returns the index of the most significant bit, or -1 if the value
is 0.
