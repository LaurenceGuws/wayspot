...
|  |  |  |
|----|----|----|
| [Uint32](Uint32.html) | **type** | the type of event to be cleared; see [SDL_EventType](SDL_EventType.html) for details. |

## Remarks

This will unconditionally remove any events from the queue that match
`type`. If you need to remove a range of event types, use
[SDL_FlushEvents](SDL_FlushEvents.html)() instead.
...
should use [SDL_PeepEvents](SDL_PeepEvents.html)() to remove and clean
up those events before calling this function.
