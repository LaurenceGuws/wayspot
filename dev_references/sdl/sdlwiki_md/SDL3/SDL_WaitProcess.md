...
|  |  |  |
|----|----|----|
| [SDL_Process](SDL_Process.html) \* | **process** | The process to wait for. |
...
before calling [SDL_WaitProcess](SDL_WaitProcess.html)(). If you don't
do this the process might be blocked indefinitely waiting for output to
be read and [SDL_WaitProcess](SDL_WaitProcess.html)() will never return
true;
