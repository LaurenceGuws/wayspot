...
|  |  |  |
|----|----|----|
| [SDL_Surface](SDL_Surface.html) \* | **surface** | the surface to use for the pixel format and palette. |
...
If the surface pixel format has an alpha component it will be returned
