...
| [SDL_CompareCallback_r](SDL_CompareCallback_r.html) | **compare** | a function used to compare elements in the array. |
| void \* | **userdata** | a pointer to pass to the compare function. |

## Return Value

(void \*) Returns a pointer to the matching element in the array, or
NULL if not found.
