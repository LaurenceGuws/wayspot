...
|  |  |  |
|----|----|----|
| [SDL_AudioStream](SDL_AudioStream.html) \* | **stream** | the stream the audio is being requested from. |
...
call, and [SDL_PutAudioStreamData](SDL_PutAudioStreamData.html) simply
queues unconverted data for later. This is different than SDL2, where
that work was done while inputting new data to the stream and requesting
the output just copied the converted data.
