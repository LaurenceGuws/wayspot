...
|  |  |  |
|----|----|----|
| [NET_StreamSocket](NET_StreamSocket.html) \* | **sock** | the stream socket to wait on. |
...
If [NET_WriteToStreamSocket](NET_WriteToStreamSocket.html)() couldn't
send all its data immediately, it will queue it to be sent later. This
function lets the app sleep until all the data is transmitted.
