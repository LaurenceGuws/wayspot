...
|  |  |  |
|----|----|----|
| [NET_StreamSocket](NET_StreamSocket.html) \* | **sock** | The socket to set a failure rate on. |
...
deal with it. To simulate this, the library will introduce some amount
...
to 100 means *everything* fails unconditionally and no further data will
