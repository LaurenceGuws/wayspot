...
|  |  |  |
|----|----|----|
| [NET_Address](NET_Address.html) \* | **address** | The [NET_Address](NET_Address.html) object to wait on. |
...
[NET_GetAddressStatus](NET_GetAddressStatus.html) from time to time
until you get a non-zero result.

## Thread Safety

It is safe to call this function from any thread, and several threads
can block on the same address simultaneously.
