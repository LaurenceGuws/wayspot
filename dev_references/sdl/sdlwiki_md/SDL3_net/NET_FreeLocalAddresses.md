...
|  |  |  |
|----|----|----|
| [NET_Address](NET_Address.html) \*\* | **addresses** | A pointer returned by [NET_GetLocalAddresses](NET_GetLocalAddresses.html)(). |

## Remarks

This will unref all addresses in the array and free the array itself.

Since addresses are reference counted, it is safe to keep any addresses
you want from this array even after calling this function, as long as
you called [NET_RefAddress](NET_RefAddress.html)() on them first.
