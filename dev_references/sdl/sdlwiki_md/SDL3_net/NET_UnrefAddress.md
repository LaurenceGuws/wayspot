...
Drop a reference to an [NET_Address](NET_Address.html).
...
|  |  |  |
|----|----|----|
| [NET_Address](NET_Address.html) \* | **address** | The [NET_Address](NET_Address.html) to drop a reference to. |
...
This function drops a reference to an [NET_Address](NET_Address.html),
