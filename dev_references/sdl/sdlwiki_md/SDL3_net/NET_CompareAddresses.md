...
Compare two [NET_Address](NET_Address.html) objects.
...
|                                          |       |                            |
|------------------------------------------|-------|----------------------------|
| const [NET_Address](NET_Address.html) \* | **a** | first address to compare.  |
| const [NET_Address](NET_Address.html) \* | **b** | second address to compare. |
