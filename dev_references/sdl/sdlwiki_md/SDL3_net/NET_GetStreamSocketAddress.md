...
([NET_Address](NET_Address.html) \*) Returns the socket's remote
address, or NULL on error; call SDL_GetError() for details.
...
This adds a reference to the address; the caller *must* call
[NET_UnrefAddress](NET_UnrefAddress.html)() when done with it.
