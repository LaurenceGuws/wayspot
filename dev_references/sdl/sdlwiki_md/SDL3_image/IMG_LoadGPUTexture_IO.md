...
There is also
[IMG_LoadGPUTextureTyped_IO](IMG_LoadGPUTextureTyped_IO.html)(), which
is equivalent to this function except a file extension (like "BMP",
"JPG", etc) can be specified, in case SDL_image cannot autodetect the
file format.
