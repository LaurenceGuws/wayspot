...
(bool) Returns a new SDL_Surface containing the decoded frame, or NULL
...
If the animation decoder has no more frames, this function returns NULL
and only sets the error if the decoding has failed.
...
- [SDL_FreeSurface](SDL_FreeSurface.html)
