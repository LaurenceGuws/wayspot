...
- [IMG_PROP_ANIMATION_DECODER_CREATE_AVIF_ALLOW_INCREMENTAL_BOOLEAN](IMG_PROP_ANIMATION_DECODER_CREATE_AVIF_ALLOW_INCREMENTAL_BOOLEAN.html)
- [IMG_PROP_ANIMATION_DECODER_CREATE_AVIF_ALLOW_PROGRESSIVE_BOOLEAN](IMG_PROP_ANIMATION_DECODER_CREATE_AVIF_ALLOW_PROGRESSIVE_BOOLEAN.html)
- [IMG_PROP_ANIMATION_DECODER_CREATE_AVIF_MAX_THREADS_NUMBER](IMG_PROP_ANIMATION_DECODER_CREATE_AVIF_MAX_THREADS_NUMBER.html)
- [IMG_PROP_ANIMATION_DECODER_CREATE_FILENAME_STRING](IMG_PROP_ANIMATION_DECODER_CREATE_FILENAME_STRING.html)
- [IMG_PROP_ANIMATION_DECODER_CREATE_GIF_NUM_COLORS_NUMBER](IMG_PROP_ANIMATION_DECODER_CREATE_GIF_NUM_COLORS_NUMBER.html)
- [IMG_PROP_ANIMATION_DECODER_CREATE_GIF_TRANSPARENT_COLOR_INDEX_NUMBER](IMG_PROP_ANIMATION_DECODER_CREATE_GIF_TRANSPARENT_COLOR_INDEX_NUMBER.html)
...
- [IMG_PROP_ANIMATION_DECODER_CREATE_TIMEBASE_DENOMINATOR_NUMBER](IMG_PROP_ANIMATION_DECODER_CREATE_TIMEBASE_DENOMINATOR_NUMBER.html)
- [IMG_PROP_ANIMATION_DECODER_CREATE_TIMEBASE_NUMERATOR_NUMBER](IMG_PROP_ANIMATION_DECODER_CREATE_TIMEBASE_NUMERATOR_NUMBER.html)
...
- [IMG_PROP_ANIMATION_ENCODER_CREATE_AVIF_KEYFRAME_INTERVAL_NUMBER](IMG_PROP_ANIMATION_ENCODER_CREATE_AVIF_KEYFRAME_INTERVAL_NUMBER.html)
- [IMG_PROP_ANIMATION_ENCODER_CREATE_AVIF_MAX_THREADS_NUMBER](IMG_PROP_ANIMATION_ENCODER_CREATE_AVIF_MAX_THREADS_NUMBER.html)
- [IMG_PROP_ANIMATION_ENCODER_CREATE_FILENAME_STRING](IMG_PROP_ANIMATION_ENCODER_CREATE_FILENAME_STRING.html)
- [IMG_PROP_ANIMATION_ENCODER_CREATE_GIF_USE_LUT_BOOLEAN](IMG_PROP_ANIMATION_ENCODER_CREATE_GIF_USE_LUT_BOOLEAN.html)
...
- [IMG_PROP_METADATA_AUTHOR_STRING](IMG_PROP_METADATA_AUTHOR_STRING.html)
- [IMG_PROP_METADATA_COPYRIGHT_STRING](IMG_PROP_METADATA_COPYRIGHT_STRING.html)
- [IMG_PROP_METADATA_CREATION_TIME_STRING](IMG_PROP_METADATA_CREATION_TIME_STRING.html)
- [IMG_PROP_METADATA_DESCRIPTION_STRING](IMG_PROP_METADATA_DESCRIPTION_STRING.html)
- [IMG_PROP_METADATA_FRAME_COUNT_NUMBER](IMG_PROP_METADATA_FRAME_COUNT_NUMBER.html)
- [IMG_PROP_METADATA_IGNORE_PROPS_BOOLEAN](IMG_PROP_METADATA_IGNORE_PROPS_BOOLEAN.html)
- [IMG_PROP_METADATA_LOOP_COUNT_NUMBER](IMG_PROP_METADATA_LOOP_COUNT_NUMBER.html)
- [IMG_PROP_METADATA_TITLE_STRING](IMG_PROP_METADATA_TITLE_STRING.html)
