...
deal with SDL_IOStream: `IMG_LoadTexture("filename.jpg")` will call this
function and manage those details for you, determining the file type
from the filename's extension.

There is also [IMG_LoadTexture_IO](IMG_LoadTexture_IO.html)(), which is
...
pixels in CPU memory), call [IMG_LoadTyped_IO](IMG_LoadTyped_IO.html)()
instead.
